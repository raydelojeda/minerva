...
var pathToImages = 'https://'+document.domain+'/minerva/img/general/calendario/';	// Relative to your HTML file
...
var selectBoxHighlightColor = '#4f67b7'; // Highlight color of select boxes
var selectBoxRolloverBgColor = '#4f67b7'; // Background color on drop down lists(rollover)
	...
	if(inputField.value.length>6){ //dates must have at least 6 digits...
       if(!inputField.value.match(/^[0-9]*?$/gi)){
			...
			if(hourPos>=0){
				...
				currentHour = tmpHour;
				if(currentHour.length==1) currentHour = '12'
			}else{
				currentHour = '12';
			}
			var minutePos = format.indexOf('ii');alert(minutePos);
			if(minutePos>=0){
