...
//cuando aparezca una linea con el comentario (NO TOCAR) se refiere a la linea, no al genero_literario
...
$elemento_titulo="de g&eacute;nero literario"; // para el título
$elemento="genero_literario"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a los genero_literarios registrados en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="n_genero_literario";// tabla de la BD

$tabla_anidada=array();
//$tabla_anidada[0]='n_genero_literario';
//$tabla_anidada[1]='';

$campo_anidado=array();
//$campo_anidado[0]='id_genero_literario';
//$campo_anidado[1]='';

$field[0]='id_genero_literario'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='genero_literario';

$alias_col=array();
$alias_col[0]='id_genero_literario';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='genero_literario';

$columna[0]=''; // labels o encabezados, $field[0] es la llave de la tabla por tanto no lleva label (NO TOCAR)
$columna[1]='G&eacute;nero literario';
...
$var_mod='';
$columna_suma[0]='';
$href_m='mod_genero_literario.php?mod='; // camino de la pagina para Editar
...
$l_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'G&eacute;nero literario');
...
$l_botones[1]=array('target'=>'_self','href'=>'#','onclic'=>'modif(\'mod_genero_literario.php\')','src'=>$x.'img/general/Editar.png','nombre'=>'editar','texto'=>'Editar','accion'=>'Editar');
...
$insert_field[0]='id_genero_literario'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='genero_literario'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
...
$ff=5;
$f=6;
$combo_sql[$f] = "select id_genero_literario as id_emp, nombre_emp as emp from n_genero_literario order by fecha_crea";
...
$n_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'G&eacute;nero literario');
...
$m_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'G&eacute;nero literario');
