...
$elemento_titulo="de pr&eacute;stamo (libro prestado y sin devolver)"; // para el título
$elemento="prestamo"; // elemento o nomenclador al que se accede
...
$tabla_anidada2[3]='curso_grado_paralelo_est';
...
$campo_anidado2[3]='id_curso_grado_paralelo_est';
...
$where=' AND libro.id_editorial=n_editorial.id_editorial AND libro.id_autor=n_autor.id_autor AND prestado="1"
...
AND n_grado_paralelo.id_paralelo=n_paralelo.id_paralelo AND n_grado_paralelo.id_grado_paralelo=grado_paralelo_periodo.id_grado_paralelo AND n_periodo_academico.id_periodo_academico=grado_paralelo_periodo.id_periodo_academico AND n_periodo_academico.activo=1';//AND fecha_dev_real=""
...
$field[12]='prestado';
$field[13]='baja';
$field[14]='n_grado.id_grado';
$field[15]='grado';
$field[16]='n_paralelo.id_paralelo';
$field[17]='paralelo';
...
$alias_col[12]='PRES';
$alias_col[13]='BAJA';
$alias_col[14]='id_grado';
$alias_col[15]='grado';
$alias_col[16]='id_para';
$alias_col[17]='para';
...
$l_botones[0]=array('target'=>'_self','href'=>'#','onclic'=>'seleccion_elem(\'devolver.php\')','src'=>$x.'img/bibl/prestamo/devolucion.png','nombre'=>'eliminar','texto'=>'Devolver','accion'=>'Editar');
...
$combo_sql[$f] = "select id_libro as ID_L, concat(no_ficha,' - ',titulo) as LIB FROM libro WHERE 1 AND prestado='0' AND baja='0'";
