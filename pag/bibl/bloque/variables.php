...
$elemento_titulo="de estante"; // para el título
$elemento="bloque"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a los bloques registrados en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="n_bloque";// tabla de la BD
...
$field[0]='id_bloque'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='bloque';

$alias_col=array();
$alias_col[0]='id_bloque';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='bloque';
...
$var_mod='';
$columna_suma[0]='';
$href_m='mod_bloque.php?mod='; // camino de la pagina para Editar
...
$l_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Bloque dentro de la ubicaci&oacute;n');
...
$l_botones[1]=array('target'=>'_self','href'=>'#','onclic'=>'modif(\'mod_bloque.php\')','src'=>$x.'img/general/Editar.png','nombre'=>'editar','texto'=>'Editar','accion'=>'Editar');
...
$insert_field[0]='id_bloque'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='bloque'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
...
$ff=5;
$f=6;
$combo_sql[$f] = "select id_bloque as id_emp, nombre_emp as emp from n_bloque order by fecha_crea";
...
$n_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Bloque dentro de la ubicaci&oacute;n');
...
$m_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Bloque dentro de la ubicaci&oacute;n');
