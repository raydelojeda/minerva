...
//cuando aparezca una linea con el comentario (NO TOCAR) se refiere a la linea, no al editorial
...
$elemento_titulo="de editorial"; // para el título
$elemento="editorial"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a los editorials registrados en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="n_editorial";// tabla de la BD
...
$field[0]='id_editorial'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='editorial';

$alias_col=array();
$alias_col[0]='id_editorial';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='editorial';
...
$var_mod='';
$columna_suma[0]='';
$href_m='mod_editorial.php?mod='; // camino de la pagina para Editar
...
$l_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Editorial');
...
$l_botones[1]=array('target'=>'_self','href'=>'#','onclic'=>'modif(\'mod_editorial.php\')','src'=>$x.'img/general/Editar.png','nombre'=>'editar','texto'=>'Editar','accion'=>'Editar');
...
$insert_field[0]='id_editorial'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='editorial'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
...
$ff=5;
$f=6;
$combo_sql[$f] = "select id_editorial as id_emp, nombre_emp as emp from n_editorial order by fecha_crea";
...
$n_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Editorial');
...
$m_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Editorial');
