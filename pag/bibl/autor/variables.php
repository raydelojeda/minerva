...
//cuando aparezca una linea con el comentario (NO TOCAR) se refiere a la linea, no al autor
...
$elemento_titulo="de autor"; // para el título
$elemento="autor"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a los autores registrados en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="n_autor";// tabla de la BD

$tabla_anidada=array();
//$tabla_anidada[0]='n_autor';
//$tabla_anidada[1]='';

$campo_anidado=array();
//$campo_anidado[0]='id_autor';
//$campo_anidado[1]='';

$field[0]='id_autor'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='autor';

$alias_col=array();
$alias_col[0]='id_autor';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='autor';
...
$var_mod='';
$columna_suma[0]='';
$href_m='mod_autor.php?mod='; // camino de la pagina para Editar
...
$l_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Autor');
...
$l_botones[1]=array('target'=>'_self','href'=>'#','onclic'=>'modif(\'mod_autor.php\')','src'=>$x.'img/general/Editar.png','nombre'=>'editar','texto'=>'Editar','accion'=>'Editar');
...
$insert_field[0]='id_autor'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='autor'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
...
$ff=5;
$f=6;
$combo_sql[$f] = "select id_autor as id_emp, nombre_emp as emp from n_autor order by fecha_crea";
...
$n_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Autor');
...
$m_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Autor');
