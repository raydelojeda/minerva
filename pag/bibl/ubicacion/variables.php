...
$elemento_titulo="de la ubicaci&oacute;n"; // para el título
$elemento="ubicacion"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a las ubicaciones registradas seg&uacute;n el division en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="n_ubicacion";// tabla de la BD

$tabla_anidada=array();
$tabla_anidada[0]='n_bloque';
$tabla_anidada[1]='n_secc';
$tabla_anidada[2]='n_division';

$campo_anidado=array();
$campo_anidado[0]='id_bloque';
$campo_anidado[1]='id_secc';
$campo_anidado[2]='id_division';

$campo_anidado2[0]='id_persona';

//$where=' AND persona.id_persona=n_bloque.id_persona';

$field[0]='id_ubicacion'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]=$tabla.'.id_bloque';
$field[2]="bloque";
$field[3]=$tabla.'.id_secc';
$field[4]='secc';
$field[5]=$tabla.'.id_division';
$field[6]='division';
$field[7]='ubicacion';

$alias_col=array();
$alias_col[0]='id_ubicacion';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='id_b';
$alias_col[2]='blo';
$alias_col[3]='id_secc';
$alias_col[4]='secc';
$alias_col[5]='id_d';
$alias_col[6]='division';
$alias_col[7]='ubi';

$columna[0]=''; // labels o encabezados, $field[0] es la llave de la tabla por tanto no lleva label (NO TOCAR)
$columna[1]='Estante';
$columna[2]='Estante';
$columna[3]='Columna dentro del estante';
$columna[4]='Columna dentro del estante';
$columna[5]='Celda dentro de la columna';
$columna[6]='Celda dentro de la columna';
$columna[7]='Ubicaci&oacute;n';
...
$var_mod='';
$columna_suma[0]='';
$href_m='mod_ubicacion.php?mod='; // camino de la pagina para Editar
...
$l_label_ayuda[0]=array('texto'=>$columna[2],'exp'=>'Divisi&oacute;n dentro de la ubicaci&oacute;n');
$l_label_ayuda[1]=array('texto'=>$columna[4],'exp'=>'Secci&oacute;n dentro de la ubicaci&oacute;n');
$l_label_ayuda[2]=array('texto'=>$columna[6],'exp'=>'Bloque dentro de la ubicaci&oacute;n');
$l_label_ayuda[3]=array('texto'=>$columna[7],'exp'=>'Ubicaci&oacute;n');
...
$insert_field[0]='id_ubicacion'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='id_bloque'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
$insert_field[2]='';
$insert_field[3]='id_secc';
$insert_field[4]='';
$insert_field[5]='id_division';
$insert_field[6]='';
$insert_field[7]='ubicacion';
...
$ff=4;
$g=2;
$combo_sql[$f] = "select id_division as id_d, division as division from n_division";

$opt_name=array();
$opt_name[$f][0]='division';//dato que va a mostrar al usuario ejem: Elemento 1, Elemento 2, etc. otro: Administrador, Vendedor, Contador, Invitado, etc. 
$opt_name[$f][1]='';//Además puedes tener del campo de la tabla en caso de selectBD
$opt_name[$f][2]='';
$opt_name[$f][3]='';

$opt_value=array();
$opt_value[$f][0]='id_d';//value del option, campo de la tabla externa de la consulta del combo
$opt_value[$f][1]='';
$opt_value[$f][2]='';
$opt_value[$f][3]='';

$opt_sel=array();
$opt_sel[$f][0]='id_d';//selected del option, campo de la tabla externa de la consulta del combo, en caso que sea de forma estática se pone en uno solo "selected"
$opt_sel[$f][1]='';// cuando sea selecBD en la primera fila se pone el alias del id de la tabla externa asociada al selecBD
$opt_sel[$f][2]='';
$opt_sel[$f][3]='';

$combo_sql[$ff] = "select id_secc as id_secc, secc as secc from n_secc";

$opt_name[$ff][0]='secc';//dato que va a mostrar al usuario ejem: Elemento 1, Elemento 2, etc. otro: Administrador, Vendedor, Contador, Invitado, etc. 
$opt_name[$ff][1]='';//Además puedes tener del campo de la tabla en caso de selectBD
$opt_name[$ff][2]='';
$opt_name[$ff][3]='';


$opt_value[$ff][0]='id_secc';//value del option, campo de la tabla externa de la consulta del combo
$opt_value[$ff][1]='';
$opt_value[$ff][2]='';
$opt_value[$ff][3]='';


$opt_sel[$ff][0]='id_secc';//selected del option, campo de la tabla externa de la consulta del combo, en caso que sea de forma estática se pone en uno solo "selected"
$opt_sel[$ff][1]='';// cuando sea selecBD en la primera fila se pone el alias del id de la tabla externa asociada al selecBD
$opt_sel[$ff][2]='';
$opt_sel[$ff][3]='';

$combo_sql[$g] = "select id_bloque as id_b, bloque as blo from n_bloque";

$opt_name[$g][0]='blo';//dato que va a mostrar al usuario ejem: Elemento 1, Elemento 2, etc. otro: Administrador, Vendedor, Contador, Invitado, etc. 
$opt_name[$g][1]='';//Además puedes tener del campo de la tabla en caso de selectBD

$opt_value[$g][0]='id_b';//value del option, campo de la tabla externa de la consulta del combo

$opt_sel[$g][0]='id_b';//selected del option, campo de la tabla externa de la consulta del combo, en caso que sea de forma estática se pone en uno solo "selected"
...
$n_label_ayuda[0]=array('texto'=>$columna[2],'exp'=>'Divisi&oacute;n dentro de la ubicaci&oacute;n');
$n_label_ayuda[1]=array('texto'=>$columna[4],'exp'=>'Secci&oacute;n dentro de la ubicaci&oacute;n');
$n_label_ayuda[2]=array('texto'=>$columna[6],'exp'=>'Bloque dentro de la ubicaci&oacute;n');
$n_label_ayuda[3]=array('texto'=>$columna[7],'exp'=>'Ubicaci&oacute;n');
...
$m_label_ayuda[0]=array('texto'=>$columna[2],'exp'=>'Divisi&oacute;n dentro de la ubicaci&oacute;n');
$m_label_ayuda[1]=array('texto'=>$columna[4],'exp'=>'Secci&oacute;n dentro de la ubicaci&oacute;n');
$m_label_ayuda[2]=array('texto'=>$columna[6],'exp'=>'Bloque dentro de la ubicaci&oacute;n');
$m_label_ayuda[3]=array('texto'=>$columna[7],'exp'=>'Ubicaci&oacute;n');
