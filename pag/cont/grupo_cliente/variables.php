...
$elemento_titulo="de grupo de consumidores para facturaci&oacute;n"; // para el título
$elemento="grupo_cliente"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a las grupo de consumidores para facturaci&oacute;ns registradas en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="n_grupo_cliente";// tabla de la BD
...
$field[0]='id_grupo_cliente'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='grupo_cliente';
$field[2]=$tabla_anidada[0].'.id_punto_venta';
$field[3]='punto_venta';

$alias_col=array();
$alias_col[0]='id_grupo_cliente';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='grupo_cliente';
$alias_col[2]='id_p';
$alias_col[3]='pun';

$columna[0]=''; // labels o encabezados, $field[0] es la llave de la tabla por tanto no lleva label (NO TOCAR)
$columna[1]='Grupo de consumidores para facturaci&oacute;n';
...
$var_mod='';
$columna_suma[0]='';
$href_m='mod_grupo_cliente.php?mod='; // camino de la pagina para Editar
...
$l_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Grupo de personas para facturaci&oacute;n');
$l_label_ayuda[1]=array('texto'=>$columna[3],'exp'=>'Punto de venta');
...
$l_botones[1]=array('target'=>'_self','href'=>'#','onclic'=>'modif(\'mod_grupo_cliente.php\')','src'=>$x.'img/general/Editar.png','nombre'=>'editar','texto'=>'Editar','accion'=>'Editar');
...
$insert_field[0]='id_grupo_cliente'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='grupo_cliente'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
$insert_field[2]='id_punto_venta';
$insert_field[3]='';
...
$ff=5;
$f=3;
$combo_sql[$f] = "select id_punto_venta as id_p, punto_venta as pun from n_punto_venta order by pun";
...
$n_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'GSrupo de personas para facturaci&oacute;n');
$n_label_ayuda[1]=array('texto'=>$columna[3],'exp'=>'Punto de venta');
...
$m_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Grupo de personas para facturaci&oacute;n');
$m_label_ayuda[1]=array('texto'=>$columna[3],'exp'=>'Punto de venta');
