...
$elemento_titulo="de inventario vigente de activos fijos"; // para el título
$elemento="r_ubicacion_responsable"; // elemento o nomenclador al que se accede
...
$where=' AND emp_resp.id_empleado=ubicacion_responsable.id_responsable AND emp_inv.id_empleado=ubicacion_responsable.id_empleado_inv
 ...
 AND fecha_mov in (select max(fecha_mov) from ubicacion_responsable as u where u.id_inventario=ubicacion_responsable.id_inventario)
 ';//AND no_inventario!=""
...
$combo_sql[$f] = "select id_inventario as id_inventario, concat(articulo,' - ',no_inventario) as inventario from inventario, n_articulo
WHERE 1 AND inventario.id_articulo=n_articulo.id_articulo ORDER BY articulo ASC";
