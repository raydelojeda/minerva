...
$elemento_titulo="de clientes y sus formas de pago"; // para el título
$elemento="cliente_forma_pago"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a las punto_ventas registradas seg&uacute;n el forma_pago en la base de datos.";//introduccion de la ayuda
...
$tabla_anidada=array();
$tabla_anidada[0]='n_forma_pago';
$tabla_anidada[1]='n_punto_venta';
$tabla_anidada[2]='cliente';

$tabla_anidada2[0]='persona';

$campo_anidado=array();
$campo_anidado[0]='id_forma_pago';
$campo_anidado[1]='id_punto_venta';
$campo_anidado[2]='id_cliente';

$campo_anidado2[0]='id_persona';

$where=' AND persona.id_persona=cliente.id_persona';

$field[0]='id_cliente_forma_pago'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]=$tabla.'.id_forma_pago';
$field[2]='forma_pago';
$field[3]=$tabla.'.id_punto_venta';
$field[4]='punto_venta';
$field[5]=$tabla.'.id_cliente';
$field[6]="concat(persona.primer_apellido,' ',persona.segundo_apellido,' ',persona.primer_nombre,' ',persona.segundo_nombre,' - ',persona.identificacion)";
$field[7]='fecha';

$alias_col=array();
$alias_col[0]='id_cliente_forma_pago';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='id_f';
$alias_col[2]='forma_pago';
$alias_col[3]='id_punto_venta';
$alias_col[4]='punto_venta';
$alias_col[5]='id_p';
$alias_col[6]='per';
$alias_col[7]='fecha';
...
$columna[3]='Punto de venta';
$columna[4]='Punto de venta';
$columna[5]='Cliente';
$columna[6]='Cliente';
$columna[7]='Fecha';
...
$var_mod='';
$columna_suma[0]='';
$href_m='mod_cliente_forma_pago.php?mod='; // camino de la pagina para Editar
...
$l_label_ayuda[0]=array('texto'=>$columna[2],'exp'=>'Forma de pago del empleado');
$l_label_ayuda[1]=array('texto'=>$columna[4],'exp'=>'Punto de venta');
$l_label_ayuda[2]=array('texto'=>$columna[6],'exp'=>'Cliente');
$l_label_ayuda[3]=array('texto'=>$columna[7],'exp'=>'Fecha en que se ingres&oacute; la forma de pago al cliente');
...
$insert_field[0]='id_cliente_forma_pago'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='id_forma_pago'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
$insert_field[2]='';
$insert_field[3]='id_punto_venta';
$insert_field[4]='';
$insert_field[5]='id_cliente';
$insert_field[6]='';
...
$ff=4;
$g=6;
$combo_sql[$f] = "select id_forma_pago as id_f, forma_pago as forma_pago from n_forma_pago WHERE para_venta='1'";

$opt_name=array();
$opt_name[$f][0]='forma_pago';//dato que va a mostrar al usuario ejem: Elemento 1, Elemento 2, etc. otro: Administrador, Vendedor, Contador, Invitado, etc. 
$opt_name[$f][1]='';//Además puedes tener del campo de la tabla en caso de selectBD
$opt_name[$f][2]='';
$opt_name[$f][3]='';

$opt_value=array();
$opt_value[$f][0]='id_f';//value del option, campo de la tabla externa de la consulta del combo
$opt_value[$f][1]='';
$opt_value[$f][2]='';
$opt_value[$f][3]='';

$opt_sel=array();
$opt_sel[$f][0]='id_f';//selected del option, campo de la tabla externa de la consulta del combo, en caso que sea de forma estática se pone en uno solo "selected"
$opt_sel[$f][1]='';// cuando sea selecBD en la primera fila se pone el alias del id de la tabla externa asociada al selecBD
$opt_sel[$f][2]='';
$opt_sel[$f][3]='';

$combo_sql[$ff] = "select id_punto_venta as id_punto_venta, punto_venta as punto_venta from n_punto_venta";

$opt_name[$ff][0]='punto_venta';//dato que va a mostrar al usuario ejem: Elemento 1, Elemento 2, etc. otro: Administrador, Vendedor, Contador, Invitado, etc. 
$opt_name[$ff][1]='';//Además puedes tener del campo de la tabla en caso de selectBD
$opt_name[$ff][2]='';
$opt_name[$ff][3]='';


$opt_value[$ff][0]='id_punto_venta';//value del option, campo de la tabla externa de la consulta del combo
$opt_value[$ff][1]='';
$opt_value[$ff][2]='';
$opt_value[$ff][3]='';


$opt_sel[$ff][0]='id_punto_venta';//selected del option, campo de la tabla externa de la consulta del combo, en caso que sea de forma estática se pone en uno solo "selected"
$opt_sel[$ff][1]='';// cuando sea selecBD en la primera fila se pone el alias del id de la tabla externa asociada al selecBD
$opt_sel[$ff][2]='';
$opt_sel[$ff][3]='';

$combo_sql[$g] = "select id_cliente as id_p, concat(primer_apellido,' ',segundo_apellido,' ',primer_nombre,' ',segundo_nombre,' - ',identificacion) as per from persona, cliente WHERE persona.id_persona=cliente.id_persona ORDER BY primer_apellido";

$opt_name[$g][0]='per';//dato que va a mostrar al usuario ejem: Elemento 1, Elemento 2, etc. otro: Administrador, Vendedor, Contador, Invitado, etc. 
$opt_name[$g][1]='';//Además puedes tener del campo de la tabla en caso de selectBD

$opt_value[$g][0]='id_p';//value del option, campo de la tabla externa de la consulta del combo

$opt_sel[$g][0]='id_p';//selected del option, campo de la tabla externa de la consulta del combo, en caso que sea de forma estática se pone en uno solo "selected"
...
$n_label_ayuda[0]=array('texto'=>$columna[2],'exp'=>'forma_pago del empleado');
$n_label_ayuda[1]=array('texto'=>$columna[4],'exp'=>'punto_venta');
$n_label_ayuda[2]=array('texto'=>$columna[6],'exp'=>'Ponderaci&oacute;n');
$n_label_ayuda[3]=array('texto'=>$columna[3],'exp'=>'fecha que debe tener el forma_pago en la punto_venta');
...
$m_label_ayuda[0]=array('texto'=>$columna[2],'exp'=>'forma_pago del empleado');
$m_label_ayuda[1]=array('texto'=>$columna[4],'exp'=>'punto_venta');
