...
$elemento_titulo="de grupo de nivel 1"; // para el título
$elemento="familia"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a los Grupo de familiaes registradas en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="n_familia";// tabla de la BD
...
$field[0]='id_familia'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='familia';

$alias_col=array();
$alias_col[0]='id_familia';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='familia';
...
$var_mod='';
$columna_suma[0]='';
$href_m='mod_familia.php?mod='; // camino de la pagina para Editar
...
$l_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Grupo de nivel 1 o clasificaci&oacute;n general');
...
$l_botones[1]=array('target'=>'_self','href'=>'#','onclic'=>'modif(\'mod_familia.php\')','src'=>$x.'img/general/Editar.png','nombre'=>'editar','texto'=>'Editar','accion'=>'Editar');
...
$insert_field[0]='id_familia'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='familia'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
...
$ff=5;
$f=6;
$combo_sql[$f] = "select id_familia as id_emp, nombre_emp as emp from n_familia order by fecha_crea";
...
$n_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Grupo de nivel 1 o clasificaci&oacute;n general');
...
$m_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Grupo de nivel 1 o clasificaci&oacute;n general');
