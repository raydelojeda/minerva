...
$elemento_titulo="de producto y precios"; // para el título
...
$field_unico=array();
$field_unico[0]=''; // fields que deben ser únicos en la tabla en la BD, diferente de 1 y vacío es para constrain, se pone el mismo Precio en los id que combinados no deben repetirse
$field_unico[1]='';
$field_unico[2]='';
$field_unico[3]='';
$field_unico[4]='';
...
$opt_name[$w][1]='';//Además puedes tener del campo de la tabla en caso de selectBD

$opt_value[$w][0]='id_p';//value del option, campo de la tabla externa de la consulta del combo
$opt_value[$w][1]='';

$opt_sel[$w][0]='id_p';//selected del option, campo de la tabla externa de la consulta del combo, en caso que sea de forma estática se pone en uno solo "selected"
