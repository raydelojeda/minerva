...
$elemento_titulo="de modelo"; // para el título
$elemento="modelo"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a los modelos registrados en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="n_modelo";// tabla de la BD

$tabla_anidada=array();
//$tabla_anidada[0]='n_modelo';
//$tabla_anidada[1]='';

$campo_anidado=array();
//$campo_anidado[0]='id_modelo';
//$campo_anidado[1]='';

$field[0]='id_modelo'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='modelo';

$alias_col=array();
$alias_col[0]='id_modelo';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='modelo';
...
$var_mod='';
$columna_suma[0]='';
$href_m='mod_modelo.php?mod='; // camino de la pagina para Editar
...
$l_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Modelo del art&iacute;culo');
...
$l_botones[1]=array('target'=>'_self','href'=>'#','onclic'=>'modif(\'mod_modelo.php\')','src'=>$x.'img/general/Editar.png','nombre'=>'editar','texto'=>'Editar','accion'=>'Editar');
...
$insert_field[0]='id_modelo'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='modelo'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
...
$ff=5;
$f=6;
$combo_sql[$f] = "select id_modelo as id_emp, nombre_emp as emp from n_modelo order by fecha_crea";
...
$mini_n_botones[0]=array('target'=>'_self','href'=>'#','onclic'=>$mini_onsubmit."if(ok==0)return false;guardar_sin_recargar('".$x.$camino."/ins_".$elemento.".php','".implode(",", $campos_origen)."','sel_modelo');",'src'=>$x.'img/general/guardar_mini.png','nombre'=>'guardar','texto'=>'Guardar','accion'=>'Insertar');
...
$n_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Modelo del art&iacute;culo');
...
$m_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Modelo del art&iacute;culo');
