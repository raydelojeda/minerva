...
$elemento="grupos_personas"; // elemento o nomenclador al que se accede
...
$tabla="grupos_personas";// tabla de la BD

$tabla_anidada[0]='n_grupo_persona';
$tabla_anidada[1]='persona';

$campo_anidado[0]='id_grupo_persona';
$campo_anidado[1]='id_persona';

$field[0]='id_grupos_personas'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]=$tabla_anidada[0].'.id_grupo_persona';
$field[2]='grupo_persona';
$field[3]=$tabla_anidada[1].'.id_persona';
...
$alias_col[0]='id_grupos_personas';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='id_g';
$alias_col[2]='gru';
$alias_col[3]='id_p';
$alias_col[4]='per';
...
$columna[1]='Grupo de persona para facturaci&oacute;n';
$columna[2]='Grupo de persona para facturaci&oacute;n';
$columna[3]='Persona';
$columna[4]='Persona';
...
$l_label_ayuda[1]=array('texto'=>$columna[4],'exp'=>'Persona');
...
$insert_field[0]='id_grupos_personas'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='id_grupo_persona'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
$insert_field[2]='';
$insert_field[3]='id_persona';
$insert_field[4]='';
...
$f=4;
$ff=2;
$combo_sql[$f] = "select persona.id_persona as id_p,concat(primer_apellido,' ',segundo_apellido,' ',primer_nombre,' ',segundo_nombre,' - ',identificacion) as per 
FROM persona ORDER BY per";
...
$combo_sql[$ff] = "select id_grupo_persona AS id_g, grupo_persona AS gru FROM n_grupo_persona ORDER BY gru";
...
$n_label_ayuda[1]=array('texto'=>$columna[4],'exp'=>'Persona');
...
$m_label_ayuda[1]=array('texto'=>$columna[4],'exp'=>'Persona');
