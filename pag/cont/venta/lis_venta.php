...
if(isset($_GET["_next_page"]))$pag=(($_GET["_next_page"]*$ver)-$ver)+1;//if(isset($_SESSION["txt_ir"]))$pag=(($_SESSION["txt_ir"]*$ver)-$ver)+1;if(isset($_GET['adodb_next_page']))$pag=(($_GET['adodb_next_page']*$ver)-$ver)+1;
// declaraciones
...
$obj->Filtro($sel_filtro2,$txt_filtro2,$sel_filtro,$txt_filtro,$filtros,$sig_ant,$cant_pag,$ver,$colspan);// filtros del listar'displayCalendar(document.frm.'.$name_input[2].',"yyyy-m-d",this);'
