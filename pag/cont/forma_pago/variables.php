...
$elemento_titulo="de forma de pago"; // para el título
$elemento="forma_pago"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a las forma de pagos registradas en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="n_forma_pago";// tabla de la BD
...
$field[0]='id_forma_pago'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='forma_pago';
$field[2]='ingreso_saldo';
$field[3]='permite_saldo_neg';
$field[4]='predeterminada';
$field[5]='para_venta';

$alias_col=array();
$alias_col[0]='id_forma_pago';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='forma_pago';
$alias_col[2]='ingre';
$alias_col[3]='perm';
$alias_col[4]='pre';
$alias_col[5]='venta';
...
$columna[2]='Ingresa saldo?';
$columna[3]='Permite saldo negativo?';
$columna[4]='Predeterminada';
$columna[5]='Para ventas';
...
$var_mod='';
$columna_suma[0]='';
$href_m='mod_forma_pago.php?mod='; // camino de la pagina para Editar
...
$l_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Forma de pago');
$l_label_ayuda[1]=array('texto'=>$columna[2],'exp'=>'Ingresa saldo?: Si o no');
$l_label_ayuda[2]=array('texto'=>$columna[3],'exp'=>'Permite saldo negativo?: Si o no');
...
$l_botones[1]=array('target'=>'_self','href'=>'#','onclic'=>'modif(\'mod_forma_pago.php\')','src'=>$x.'img/general/Editar.png','nombre'=>'editar','texto'=>'Editar','accion'=>'Editar');
...
$insert_field[0]='id_forma_pago'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='forma_pago'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
$insert_field[2]='ingreso_saldo';
$insert_field[3]='permite_saldo_neg';
$insert_field[4]='predeterminada';
$insert_field[5]='para_venta';
...
$opt_name=array();
$opt_name[$ff][0]='Si';//dato que va a mostrar al usuario ejem: Elemento 1, Elemento 2, etc. otro: Administrador, Vendedor, Contador, Invitado, etc. 
$opt_name[$ff][1]='No';//Además puedes tener del campo de la tabla en caso de selectBD

$opt_value=array();
$opt_value[$ff][0]='1';//value del option, campo de la tabla externa de la consulta del combo
$opt_value[$ff][1]='0';

$opt_sel=array();
$opt_sel[$ff][0]='';//selected del option, campo de la tabla externa de la consulta del combo, en caso que sea de forma estática se pone en uno solo "selected"
...
$opt_sel[$r][0]='';//selected del option, campo de la tabla externa de la consulta del combo, en caso que sea de forma estática se pone en uno solo "selected"
...
$n_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Forma de pago');
$n_label_ayuda[1]=array('texto'=>$columna[2],'exp'=>'Ingresa saldo?: Si o no');
$n_label_ayuda[2]=array('texto'=>$columna[3],'exp'=>'Permite saldo negativo?: Si o no');
...
$m_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Forma de pago');
$m_label_ayuda[1]=array('texto'=>$columna[2],'exp'=>'Ingresa saldo?: Si o no');
$m_label_ayuda[2]=array('texto'=>$columna[3],'exp'=>'Permite saldo negativo?: Si o no');
