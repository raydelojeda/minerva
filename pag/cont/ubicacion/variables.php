...
$tabla_anidada=array();
$tabla_anidada[0]='n_division';
$tabla_anidada[1]='n_secc';
$tabla_anidada[2]='n_bloque';

$campo_anidado=array();
$campo_anidado[0]='id_division';
$campo_anidado[1]='id_secc';
$campo_anidado[2]='id_bloque';
...
$columna[4]='Secci&oacute;n';
$columna[5]='Divisi&oacute;n';
$columna[6]='Divisi&oacute;n';
...
$combo_sql[$g] = "select id_bloque as id_b, bloque as bloque from n_bloque";

$opt_name[$g][0]='bloque';//dato que va a mostrar al usuario ejem: Elemento 1, Elemento 2, etc. otro: Administrador, Vendedor, Contador, Invitado, etc. 
