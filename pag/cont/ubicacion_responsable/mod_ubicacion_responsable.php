...
$inputs[1]['texto_input']='La fecha y hora ser&aacute; de la &uacute;ltima modificaci&oacute;n al momento de guardar.';
...
{
	$_POST['fecha_mov']=date('Y-m-d H:i:s');
...
<script language="JavaScript" type="text/javascript"><?php print 'ejecutar_ajax("'.$x.$camino.'/sel_responsable_actual.php","no_inv","div_responsable");';?></script>
<!--Incertar Contenido Aqui-->
<!--Incertar Contenido Aqui-->
<!--Incertar Contenido Aqui-->
<?php
