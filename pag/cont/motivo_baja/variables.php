...
$elemento_titulo="de motivo de baja"; // para el título
$elemento="motivo_baja"; // elemento o nomenclador al que se accede
...
$tabla="n_motivo_baja";// tabla de la BD

$tabla_anidada=array();
//$tabla_anidada[0]='n_motivo_baja';
//$tabla_anidada[1]='';

$campo_anidado=array();
//$campo_anidado[0]='id_motivo_baja';
//$campo_anidado[1]='';

$field[0]='id_motivo_baja'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='motivo_baja';

$alias_col=array();
$alias_col[0]='id_motivo_baja';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='motivo_baja';
...
$var_mod='';
$columna_suma[0]='';
$href_m='mod_motivo_baja.php?mod='; // camino de la pagina para Editar
...
$l_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Motivo de la baja del art&iacute;culo');
...
$l_botones[1]=array('target'=>'_self','href'=>'#','onclic'=>'modif(\'mod_motivo_baja.php\')','src'=>$x.'img/general/Editar.png','nombre'=>'editar','texto'=>'Editar','accion'=>'Editar');
...
$insert_field[0]='id_motivo_baja'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='motivo_baja'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
...
$ff=5;
$f=6;
$combo_sql[$f] = "select id_motivo_baja as id_emp, nombre_emp as emp from n_motivo_baja order by fecha_crea";
...
$n_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Motivo de la baja del art&iacute;culo');
...
$m_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Motivo de la baja del art&iacute;culo');
