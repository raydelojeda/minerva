...
$elemento_titulo="de grupo de personas para facturaci&oacute;n"; // para el título
$elemento="grupo_persona"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a las grupo de personas para facturaci&oacute;ns registradas en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="n_grupo_persona";// tabla de la BD

$tabla_anidada=array();
//$tabla_anidada[0]='n_grupo_persona';
//$tabla_anidada[1]='';

$campo_anidado=array();
//$campo_anidado[0]='id_grupo_persona';
//$campo_anidado[1]='';

$field[0]='id_grupo_persona'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='grupo_persona';

$alias_col=array();
$alias_col[0]='id_grupo_persona';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='grupo_persona';

$columna[0]=''; // labels o encabezados, $field[0] es la llave de la tabla por tanto no lleva label (NO TOCAR)
$columna[1]='Grupo de personas para facturaci&oacute;n';
...
$var_mod='';
$columna_suma[0]='';
$href_m='mod_grupo_persona.php?mod='; // camino de la pagina para Editar
...
$l_botones[1]=array('target'=>'_self','href'=>'#','onclic'=>'modif(\'mod_grupo_persona.php\')','src'=>$x.'img/general/Editar.png','nombre'=>'editar','texto'=>'Editar','accion'=>'Editar');
...
$insert_field[0]='id_grupo_persona'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='grupo_persona'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
...
$ff=5;
$f=6;
$combo_sql[$f] = "select id_grupo_persona as id_emp, nombre_emp as emp from n_grupo_persona order by fecha_crea";
