...
$elemento_titulo="de tipo de depreciaci&oacute;n"; // para el título
$elemento="tipo_depreciacion"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a los tipos de depreciaci&oacute;n registrados en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="n_tipo_depreciacion";// tabla de la BD

$tabla_anidada=array();
//$tabla_anidada[0]='n_tipo_depreciacion';
//$tabla_anidada[1]='';

$campo_anidado=array();
//$campo_anidado[0]='id_tipo_depreciacion';
//$campo_anidado[1]='';

$field[0]='id_tipo_depreciacion'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='tipo_depreciacion';

$alias_col=array();
$alias_col[0]='id_tipo_depreciacion';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='sel_tipo_depreciacion';

$columna[0]=''; // labels o encabezados, $field[0] es la llave de la tabla por tanto no lleva label (NO TOCAR)
$columna[1]='Tipo de depreciaci&oacute;n';
...
$var_mod='';
$columna_suma[0]='';
$href_m='mod_tipo_depreciacion.php?mod='; // camino de la pagina para Editar
...
$l_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Tipo de depreciaci&oacute;n del art&iacute;culo');
...
$l_botones[1]=array('target'=>'_self','href'=>'#','onclic'=>'modif(\'mod_tipo_depreciacion.php\')','src'=>$x.'img/general/Editar.png','nombre'=>'editar','texto'=>'Editar','accion'=>'Editar');
...
$insert_field[0]='id_tipo_depreciacion'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='tipo_depreciacion'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
...
$ff=5;
$f=6;
$combo_sql[$f] = "select id_tipo_depreciacion as id_emp, nombre_emp as emp from n_tipo_depreciacion order by fecha_crea";
...
$mini_n_botones[0]=array('target'=>'_self','href'=>'#','onclic'=>$mini_onsubmit."if(ok==0)return false;guardar_sin_recargar('".$x.$camino."/ins_".$elemento.".php','".implode(",", $campos_origen)."','tipo_depreciacion');",'src'=>$x.'img/general/guardar_mini.png','nombre'=>'guardar','texto'=>'Guardar','accion'=>'Insertar');
...
$n_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Tipo de depreciaci&oacute;n del art&iacute;culo');
...
$m_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Tipo de depreciaci&oacute;n del art&iacute;culo');
