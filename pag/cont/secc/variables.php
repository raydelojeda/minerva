...
$elemento_titulo="de secci&oacute;n"; // para el título
$elemento="secc"; // elemento o nomenclador al que se accede
...
$tabla="n_secc";// tabla de la BD

$tabla_anidada=array();
//$tabla_anidada[0]='n_secc';
//$tabla_anidada[1]='';

$campo_anidado=array();
//$campo_anidado[0]='id_secc';
//$campo_anidado[1]='';

$field[0]='id_secc'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='secc';

$alias_col=array();
$alias_col[0]='id_secc';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='secc';

$columna[0]=''; // labels o encabezados, $field[0] es la llave de la tabla por tanto no lleva label (NO TOCAR)
$columna[1]='Secci&oacute;n';
...
$var_mod='';
$columna_suma[0]='';
$href_m='mod_secc.php?mod='; // camino de la pagina para Editar
...
$l_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Secci&oacute;n dentro de la ubicaci&oacute;n');
...
$l_botones[1]=array('target'=>'_self','href'=>'#','onclic'=>'modif(\'mod_secc.php\')','src'=>$x.'img/general/Editar.png','nombre'=>'editar','texto'=>'Editar','accion'=>'Editar');
...
$insert_field[0]='id_secc'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='secc'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
...
$ff=5;
$f=6;
$combo_sql[$f] = "select id_secc as id_emp, nombre_emp as emp from n_secc order by fecha_crea";
...
$n_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Secci&oacute;n dentro de la ubicaci&oacute;n');
...
$m_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Secci&oacute;n dentro de la ubicaci&oacute;n');
