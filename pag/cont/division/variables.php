...
$elemento_titulo="de divisi&oacute;n"; // para el título
$elemento="division"; // elemento o nomenclador al que se accede
...
$tabla="n_division";// tabla de la BD
...
$field[0]='id_division'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='division';

$alias_col=array();
$alias_col[0]='id_division';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='division';

$columna[0]=''; // labels o encabezados, $field[0] es la llave de la tabla por tanto no lleva label (NO TOCAR)
$columna[1]='Divisi&oacute;n';
...
$var_mod='';
$columna_suma[0]='';
$href_m='mod_division.php?mod='; // camino de la pagina para Editar
...
$l_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Divisi&oacute;n dentro de la ubicaci&oacute;n');
...
$l_botones[1]=array('target'=>'_self','href'=>'#','onclic'=>'modif(\'mod_division.php\')','src'=>$x.'img/general/Editar.png','nombre'=>'editar','texto'=>'Editar','accion'=>'Editar');
...
$insert_field[0]='id_division'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='division'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
...
$ff=5;
$f=6;
$combo_sql[$f] = "select id_division as id_emp, nombre_emp as emp from n_division order by fecha_crea";
...
$n_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Divisi&oacute;n dentro de la ubicaci&oacute;n');
...
$m_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Divisi&oacute;n dentro de la ubicaci&oacute;n');
