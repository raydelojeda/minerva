...
$elemento_titulo="de punto de venta y usuario"; // para el título
...
$opt_sel=array();
$opt_sel[$f][0]='id_u';//selected del option, campo de la tabla externa de la consulta del combo, en caso que sea de forma estática se pone en uno solo "selected"
