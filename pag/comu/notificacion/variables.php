...
$elemento_titulo="de bandeja de entrada y bandeja de enviados"; // para el título
...
$titulo_listar="Administraci&oacute;n ".$elemento_titulo.""; //titulo del encabezado
$titulo_nuevo="Administraci&oacute;n ".$elemento_titulo.""; //titulo del encabezado
$titulo_editar="Administraci&oacute;n ".$elemento_titulo.""; //titulo del encabezado
...
$where=" AND recibidos.id_persona_remitente=remit.id_persona AND recibidos.id_persona_destinatario=dest.id_persona AND dest.id_persona=usuario.id_persona AND usuario.activo='1'
 AND remit.email!='' AND archivado_dest='0' AND usuario.usuario='".$_SESSION['user']."'";
...
$field[1]='urgente';
$field[2]=$tabla.'.id_persona_remitente';
$field[3]="concat(remit.primer_apellido,' ',remit.primer_nombre)";
$field[4]='asunto';
$field[5]='fecha_envio';
$field[6]='leido';

$field_busqueda=array();
$field_busqueda[0]='remit.primer_apellido'; 
$field_busqueda[1]='remit.primer_nombre';
...
$var_mod='';
$columna_suma[0]='';
$href_m='mod_notificacion.php?mod='; // camino de la pagina para Editar
...
$l_botones[1]=array('target'=>'_self','href'=>'#','onclic'=>'seleccion(\'archivar.php\')','src'=>$x.'img/general/archivar.png','nombre'=>'eliminar','texto'=>'Archivar','accion'=>'Eliminar');
...
$onsubmit3="validar_form('txt_asunto','','Rvarchar')";

$n_botones=array(); // botonera que va a tener en el encabezado (NO TOCAR)
$n_botones[0]=array('target'=>'_self','href'=>'#','onclic'=>$onsubmit3,'src'=>$x.'img/general/enviar.png','nombre'=>'enviar','texto'=>'Enviar','accion'=>'');
$n_botones[1]=array('target'=>'_self','href'=>'lis_'.$elemento.'.php','onclic'=>'vaciar_tmp();mostrarArchivos();','src'=>$x.'img/general/cancelar.png','nombre'=>'cancelar','texto'=>'Salir','accion'=>'');
