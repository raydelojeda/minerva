...
$elemento_titulo="de criterio"; // para el título
$elemento="criterio"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a los criterios registradas en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="n_criterio";// tabla de la BD

$tabla_anidada=array();
//$tabla_anidada[0]='n_criterio';
//$tabla_anidada[1]='';

$campo_anidado=array();
//$campo_anidado[0]='id_criterio';
//$campo_anidado[1]='';

$field[0]='id_criterio'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='cod_criterio';
$field[2]='criterio';

$alias_col=array();
$alias_col[0]='id_criterio';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='cod';
$alias_col[2]='criterio';

$columna[0]=''; // labels o encabezados, $field[0] es la llave de la tabla por tanto no lleva label (NO TOCAR)
$columna[1]='C&oacute;digo de criterio';
$columna[2]='Criterio';
...
$l_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'C&oacute;digo del criterio de una competencia a evaluar');
$l_label_ayuda[1]=array('texto'=>$columna[2],'exp'=>'Criterio de una competencia a evaluar');
...
$insert_field[0]='id_criterio'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='cod_criterio'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
$insert_field[2]='criterio';
...
$ff=5;
$f=6;
$combo_sql[$f] = "select id_criterio as id_emp, nombre_emp as emp from n_criterio order by fecha_crea";
...
$n_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'C&oacute;digo del criterio de una competencia a evaluar');
$n_label_ayuda[1]=array('texto'=>$columna[2],'exp'=>'Criterio de una competencia a evaluar');
...
$m_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'C&oacute;digo del criterio de una competencia a evaluar');
$m_label_ayuda[1]=array('texto'=>$columna[2],'exp'=>'Criterio de una competencia a evaluar');
