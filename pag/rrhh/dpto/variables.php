...
$elemento="dpto"; // elemento o nomenclador al que se accede
...
$tabla="n_dpto";// tabla de la BD

$tabla_anidada=array();
//$tabla_anidada[0]='n_dpto';
//$tabla_anidada[1]='';

$campo_anidado=array();
//$campo_anidado[0]='id_dpto';
//$campo_anidado[1]='';

$field[0]='id_dpto'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='dpto';

$alias_col=array();
$alias_col[0]='id_dpto';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='dpto';
...
$var_mod='';
$columna_suma[0]='';
$href_m='mod_dpto.php?mod='; // camino de la pagina para Editar
...
$l_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Departamento del empleado');
...
$l_botones[1]=array('target'=>'_self','href'=>'#','onclic'=>'modif(\'mod_dpto.php\')','src'=>$x.'img/general/Editar.png','nombre'=>'editar','texto'=>'Editar','accion'=>'Editar');
...
$insert_field[0]='id_dpto'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='dpto'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
...
$ff=5;
$f=6;
$combo_sql[$f] = "select id_dpto as id_emp, nombre_emp as emp from n_dpto order by fecha_crea";
...
$mini_n_botones[0]=array('target'=>'_self','href'=>'#','onclic'=>$mini_onsubmit."if(ok==0)return false;guardar_sin_recargar('".$x.$camino."/ins_".$elemento.".php','".implode(",", $campos_origen)."','DPTO');",'src'=>$x.'img/general/guardar_mini.png','nombre'=>'guardar','texto'=>'Guardar','accion'=>'Insertar');
...
$n_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Departamento del empleado');
...
$m_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Departamento del empleado');
