...
$elemento_titulo="de causa de ausencia"; // para el título
$elemento="causa_ausencia"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a las causas de permisos registradas en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="n_causa_ausencia";// tabla de la BD

$tabla_anidada=array();
//$tabla_anidada[0]='n_causa_ausencia';
//$tabla_anidada[1]='';

$campo_anidado=array();
//$campo_anidado[0]='id_causa_ausencia';
//$campo_anidado[1]='';

$field[0]='id_causa_ausencia'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='causa_ausencia';

$alias_col=array();
$alias_col[0]='id_causa_ausencia';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='causa_ausencia';

$columna[0]=''; // labels o encabezados, $field[0] es la llave de la tabla por tanto no lleva label (NO TOCAR)
$columna[1]='Causa de ausencia';
...
$var_mod='';
$columna_suma[0]='';
$href_m='mod_causa_ausencia.php?mod='; // camino de la pagina para Editar
...
$l_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Causa de ausencia del empleado');
...
$l_botones[1]=array('target'=>'_self','href'=>'#','onclic'=>'modif(\'mod_causa_ausencia.php\')','src'=>$x.'img/general/Editar.png','nombre'=>'editar','texto'=>'Editar','accion'=>'Editar');
...
$insert_field[0]='id_causa_ausencia'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='causa_ausencia'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
...
$ff=5;
$f=6;
$combo_sql[$f] = "select id_causa_ausencia as id_emp, nombre_emp as emp from n_causa_ausencia order by fecha_crea";
...
$n_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Causa de ausencia del empleado');
...
$m_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Causa de ausencia del empleado');
