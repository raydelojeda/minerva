...
$elemento_titulo="de evaluaci&oacute;n de desempe&ntilde;o (evaluado)"; // para el título
...
$titulo_listar="<img width='60%' border='0' src='".$x."img/rrhh/desempeno2/encabezado_iso.png'/>"; //titulo del encabezado
