...
$elemento_titulo="de la evaluaci&oacute;n de desempe&ntilde;o"; // para el título
$elemento="r_graf_colum_basica_desempeno"; // elemento o nomenclador al que se accede
...
if(isset($_POST['sel_periodo_ini']) AND isset($_POST['sel_competencia']) AND $_POST['sel_competencia']!='0')
{	
	if(isset($_POST['sel_competencia']))
	{
		if($_POST['sel_competencia']=='all' OR $_POST['sel_competencia']=='all_s' OR $_POST['sel_competencia']=='0')
		{
			$campos_select="competencia as leyenda, concat(fecha_ini,'/',fecha_fin) AS periodo, AVG(resultado_cri) as valor, primer_nombre";
		}
	}
	...
	$from_y=" FROM n_seccion,desempeno,empleado,n_criterio,n_evaluacion,n_competencia,n_periodo,compromiso,persona
	WHERE 1 
	...
	if(isset($_POST['sel_seccion']) AND $_POST['sel_seccion']!=0)$from_y=$from_y." AND empleado.id_seccion = '".$_POST['sel_seccion']."'";
	...
	if(isset($_POST['sel_competencia']))
	{
		if($_POST['sel_competencia']=='all' OR $_POST['sel_competencia']=='0')
		{
			$from_y=$from_y." GROUP BY primer_nombre, competencia ,fecha_ini";
		}
	}
	
	if(isset($_POST['sel_competencia']))
	{
		if($_POST['sel_competencia']=='all_s')
		{
			$from_y=$from_y." GROUP BY competencia ,fecha_ini";
		}
	}
	...
	$from_y=$from_y." ORDER BY criterio, leyenda, fecha_ini ASC";//
