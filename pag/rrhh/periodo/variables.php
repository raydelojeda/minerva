...
$elemento_titulo="de per&iacute;odo"; // para el título
$elemento="periodo"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a los per&iacute;odos registrados en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="n_periodo";// tabla de la BD

$tabla_anidada=array();
//$tabla_anidada[0]='n_periodo';
//$tabla_anidada[1]='';

$campo_anidado=array();
//$campo_anidado[0]='id_periodo';
//$campo_anidado[1]='';

$field[0]='id_periodo'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='fecha_ini';
$field[2]='fecha_fin';
$field[3]='fecha_conclusion';

$alias_col=array();
$alias_col[0]='id_periodo';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='fecha_ini';
$alias_col[2]='fecha_fin';
$alias_col[3]='fecha_conclusion';

$columna[0]=''; // labels o encabezados, $field[0] es la llave de la tabla por tanto no lleva label (NO TOCAR)
$columna[1]='Fecha inicial de evaluaci&oacute;n';
$columna[2]='Fecha final de evaluaci&oacute;n';
$columna[3]='Fecha de conclusi&oacute;n';
...
$l_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Fecha inicial del per&iacute;odo de evaluaci&oacute;n');
$l_label_ayuda[1]=array('texto'=>$columna[2],'exp'=>'Fecha final del per&iacute;odo de evaluaci&oacute;n');
$l_label_ayuda[2]=array('texto'=>$columna[3],'exp'=>'Fecha de conclusi&oacute;n del per&iacute;odo de evaluaci&oacute;n');
...
$insert_field[0]='id_periodo'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='fecha_ini'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
$insert_field[2]='fecha_fin';
$insert_field[3]='Fecha_conclusion';
...
$ff=5;
$f=6;
$combo_sql[$f] = "select id_periodo as id_emp, nombre_emp as emp from n_periodo order by fecha_crea";
...
$opt_sel=array();
$opt_sel[$f][0]='id_emp';//selected del option, campo de la tabla externa de la consulta del combo, en caso que sea de forma estática se pone en uno solo "selected"
...
$n_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Fecha inicial del per&iacute;odo de evaluaci&oacute;n');
$n_label_ayuda[1]=array('texto'=>$columna[2],'exp'=>'Fecha final del per&iacute;odo de evaluaci&oacute;n');
$n_label_ayuda[2]=array('texto'=>$columna[3],'exp'=>'Fecha de conclusi&oacute;n del per&iacute;odo de evaluaci&oacute;n');
...
$m_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Fecha inicial del per&iacute;odo de evaluaci&oacute;n');
$m_label_ayuda[1]=array('texto'=>$columna[2],'exp'=>'Fecha final del per&iacute;odo de evaluaci&oacute;n');
$m_label_ayuda[2]=array('texto'=>$columna[3],'exp'=>'Fecha de conclusi&oacute;n del per&iacute;odo de evaluaci&oacute;n');
