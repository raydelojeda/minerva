...
$elemento_titulo="de tipo de contrato"; // para el título
$elemento="tipo_contrato"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a los tipos de contrato registrados en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="n_tipo_contrato";// tabla de la BD

$tabla_anidada=array();
//$tabla_anidada[0]='n_tipo_contrato';
//$tabla_anidada[1]='';

$campo_anidado=array();
//$campo_anidado[0]='id_tipo_contrato';
//$campo_anidado[1]='';

$field[0]='id_tipo_contrato'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='tipo_contrato';

$alias_col=array();
$alias_col[0]='id_tipo_contrato';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='tipo_contrato';

$columna[0]=''; // labels o encabezados, $field[0] es la llave de la tabla por tanto no lleva label (NO TOCAR)
$columna[1]='Tipo de contrato';
...
$var_mod='';
$columna_suma[0]='';
$href_m='mod_tipo_contrato.php?mod='; // camino de la pagina para Editar
...
$l_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Tipo de contrato del empleado');
...
$l_botones[1]=array('target'=>'_self','href'=>'#','onclic'=>'modif(\'mod_tipo_contrato.php\')','src'=>$x.'img/general/Editar.png','nombre'=>'editar','texto'=>'Editar','accion'=>'Editar');
...
$insert_field[0]='id_tipo_contrato'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='tipo_contrato'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
...
$ff=5;
$f=6;
$combo_sql[$f] = "select id_tipo_contrato as id_emp, nombre_emp as emp from n_tipo_contrato order by fecha_crea";
...
$n_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Tipo de contrato del empleado');
...
$m_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Tipo de contrato del empleado');
