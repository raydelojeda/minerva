...
$elemento_titulo="de pa&iacute;s"; // para el título
$elemento="pais"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a los pa&iacute;ses registradas en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="n_pais";// tabla de la BD
...
$field[0]='id_pais'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='pais';

$alias_col=array();
$alias_col[0]='id_pais';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='pais';

$columna[0]=''; // labels o encabezados, $field[0] es la llave de la tabla por tanto no lleva label (NO TOCAR)
$columna[1]='Pa&iacute;s';
...
$var_mod='';
$columna_suma[0]='';
$href_m='mod_pais.php?mod='; // camino de la pagina para Editar
...
$l_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Pa&iacute;s de nacimiento de la persona');
...
$l_botones[1]=array('target'=>'_self','href'=>'#','onclic'=>'modif(\'mod_pais.php\')','src'=>$x.'img/general/Editar.png','nombre'=>'editar','texto'=>'Editar','accion'=>'Editar');
...
$insert_field[0]='id_pais'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='pais'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
...
$ff=5;
$f=6;
$combo_sql[$f] = "select id_pais as id_emp, nombre_emp as emp from n_pais order by fecha_crea";
...
$n_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Pa&iacute;s de nacimiento de la persona');
...
$m_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Pa&iacute;s de nacimiento de la persona');
