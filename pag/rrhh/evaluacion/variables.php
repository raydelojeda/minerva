...
$elemento_titulo="de evaluaci&oacute;n"; // para el título
$elemento="evaluacion"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a las evaluaciones registradas en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="n_evaluacion";// tabla de la BD
...
$field[0]='id_evaluacion'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='cod_evaluacion';
$field[2]='evaluacion';
$field[3]='valor_e';
$field[4]='exp_eval';
$field[5]=$tabla.'.id_grupo_eval';
$field[6]='grupo_eval';
$field[7]='orden_e';

$alias_col=array();
$alias_col[0]='id_evaluacion';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='cod_evaluacion';
$alias_col[2]='evaluacion';
$alias_col[3]='valor';
$alias_col[4]='exp';
$alias_col[5]='id_e';
$alias_col[6]='grupo';
...
$columna[1]='C&oacute;digo de evaluaci&oacute;n';
$columna[2]='Evaluaci&oacute;n';
$columna[3]='Valor';
$columna[4]='Explicaci&oacute;n de evaluaci&oacute;n';
$columna[5]='Grupo de evaluaci&oacute;n';
$columna[6]='Grupo de evaluaci&oacute;n';
$columna[7]='Orden';
...
$l_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'C&oacute;digo de evaluaci&oacute;n del criterio');
$l_label_ayuda[1]=array('texto'=>$columna[2],'exp'=>'Evaluaci&oacute;n del criterio');
$l_label_ayuda[2]=array('texto'=>$columna[3],'exp'=>'Valor del criterio');
$l_label_ayuda[3]=array('texto'=>$columna[4],'exp'=>'Explicaci&oacute;n de la evaluaci&oacute;n del criterio');
$l_label_ayuda[4]=array('texto'=>$columna[6],'exp'=>'Grupo de la evaluaci&oacute;n del criterio');
$l_label_ayuda[5]=array('texto'=>$columna[7],'exp'=>'Orden de la evaluaci&oacute;n del criterio');
...
$insert_field[0]='id_evaluacion'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='cod_evaluacion'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
$insert_field[2]='evaluacion';
$insert_field[3]='valor_e';
$insert_field[4]='exp_eval';
$insert_field[5]='id_grupo_eval';
$insert_field[6]='';
$insert_field[7]='orden_e';
...
$label_input[7]="Orden dentro del grupo";
...
$n_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'C&oacute;digo de evaluaci&oacute;n del criterio');
$n_label_ayuda[1]=array('texto'=>$columna[2],'exp'=>'Evaluaci&oacute;n del criterio');
$n_label_ayuda[2]=array('texto'=>$columna[3],'exp'=>'Valor del criterio');
$n_label_ayuda[3]=array('texto'=>$columna[4],'exp'=>'Explicaci&oacute;n de la evaluaci&oacute;n del criterio');
$n_label_ayuda[4]=array('texto'=>$columna[6],'exp'=>'Grupo de la evaluaci&oacute;n del criterio');
$n_label_ayuda[5]=array('texto'=>$columna[7],'exp'=>'Orden de la evaluaci&oacute;n del criterio');
...
$m_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'C&oacute;digo de evaluaci&oacute;n del criterio');
$m_label_ayuda[1]=array('texto'=>$columna[2],'exp'=>'Evaluaci&oacute;n del criterio');
$m_label_ayuda[2]=array('texto'=>$columna[3],'exp'=>'Valor del criterio');
$m_label_ayuda[3]=array('texto'=>$columna[4],'exp'=>'Explicaci&oacute;n de la evaluaci&oacute;n del criterio');
$m_label_ayuda[4]=array('texto'=>$columna[6],'exp'=>'Grupo de la evaluaci&oacute;n del criterio');
$m_label_ayuda[5]=array('texto'=>$columna[7],'exp'=>'Orden de la evaluaci&oacute;n del criterio');
