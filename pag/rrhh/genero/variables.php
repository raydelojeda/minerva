...
$elemento_titulo="de g&eacute;nero"; // para el título
$elemento="genero"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a los g&eacute;neros registradas en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="n_genero";// tabla de la BD

$tabla_anidada=array();
//$tabla_anidada[0]='n_genero';
//$tabla_anidada[1]='';

$campo_anidado=array();
//$campo_anidado[0]='id_genero';
//$campo_anidado[1]='';

$field[0]='id_genero'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='genero';

$alias_col=array();
$alias_col[0]='id_gen';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='gen';

$columna[0]=''; // labels o encabezados, $field[0] es la llave de la tabla por tanto no lleva label (NO TOCAR)
$columna[1]='G&eacute;nero';
...
$var_mod='';
$columna_suma[0]='';
$href_m='mod_genero.php?mod='; // camino de la pagina para Editar
...
$l_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'G&eacute;nero de la persona');
...
$insert_field[0]='id_genero'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='genero'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
...
$ff=5;
$f=6;
$combo_sql[$f] = "select id_genero as id_emp, nombre_emp as emp from n_genero order by fecha_crea";
...
$n_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'G&eacute;nero de la persona');
...
$m_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'G&eacute;nero de la persona');
