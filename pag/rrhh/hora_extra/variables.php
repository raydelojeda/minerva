...
$elemento_titulo="de horas extras"; // para el título
$elemento="hora_extra"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a las horas extras y costo registradas en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="c_hora_extra";// tabla de la BD

$tabla_anidada=array();
$tabla_anidada[0]='c_jornada_extra';
$tabla_anidada[1]='c_costo_horas_extras';

$campo_anidado=array();
$campo_anidado[0]='id_jornada_extra';
$campo_anidado[1]='id_costo_horas_extras';

$field[0]='id_hora_extra'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]=$tabla.'.id_jornada_extra';
$field[2]='extra_ini';
$field[3]='extra_fin';
$field[4]=$tabla.'.id_costo_horas_extras';
$field[5]='costo';

$alias_col=array();
$alias_col[0]='id_hora_extra';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='id_j';
$alias_col[2]='ini';
$alias_col[3]='fin';
$alias_col[4]='id_costo';
$alias_col[5]='costo';
...
$var_mod='';
$columna_suma[0]='';
$href_m='mod_hora_extra.php?mod='; // camino de la pagina para Editar
...
$l_label_ayuda[0]=array('texto'=>$columna[2],'exp'=>'Hora inicial de la jornada extra');
$l_label_ayuda[1]=array('texto'=>$columna[3],'exp'=>'Hora final de la jornada extra');
$l_label_ayuda[2]=array('texto'=>$columna[5],'exp'=>'Costo por hora de la jornada extra');
...
$insert_field[0]='id_hora_extra'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='id_jornada_extra'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
$insert_field[2]='';
$insert_field[3]='id_costo_horas_extras';
$insert_field[4]='';
...
$f=2;
$ff=4;
$combo_sql[$f] = "select id_jornada_extra as id_j, concat(extra_ini,' - ',extra_fin) as jornada from c_jornada_extra";

$opt_name=array();
$opt_name[$f][0]='jornada';//dato que va a mostrar al usuario ejem: Elemento 1, Elemento 2, etc. otro: Administrador, Vendedor, Contador, Invitado, etc. 
$opt_name[$f][1]='';//Además puedes tener del campo de la tabla en caso de selectBD
$opt_name[$f][2]='';
$opt_name[$f][3]='';

$opt_value=array();
$opt_value[$f][0]='id_j';//value del option, campo de la tabla externa de la consulta del combo
$opt_value[$f][1]='';
$opt_value[$f][2]='';
$opt_value[$f][3]='';

$opt_sel=array();
$opt_sel[$f][0]='id_j';//selected del option, campo de la tabla externa de la consulta del combo, en caso que sea de forma estática se pone en uno solo "selected"
$opt_sel[$f][1]='';// cuando sea selecBD en la primera fila se pone el alias del id de la tabla externa asociada al selecBD
$opt_sel[$f][2]='';
$opt_sel[$f][3]='';

$combo_sql[$ff] = "select id_costo_horas_extras as id_costo, costo as costo from c_costo_horas_extras";


$opt_name[$ff][0]='costo';//dato que va a mostrar al usuario ejem: Elemento 1, Elemento 2, etc. otro: Administrador, Vendedor, Contador, Invitado, etc. 
$opt_name[$ff][1]='';//Además puedes tener del campo de la tabla en caso de selectBD
$opt_name[$ff][2]='';
$opt_name[$ff][3]='';


$opt_value[$ff][0]='id_costo';//value del option, campo de la tabla externa de la consulta del combo
$opt_value[$ff][1]='';
$opt_value[$ff][2]='';
$opt_value[$ff][3]='';


$opt_sel[$ff][0]='id_costo';//selected del option, campo de la tabla externa de la consulta del combo, en caso que sea de forma estática se pone en uno solo "selected"
...
$n_label_ayuda[0]=array('texto'=>$columna[2],'exp'=>'Hora inicial de la jornada extra');
$n_label_ayuda[1]=array('texto'=>$columna[3],'exp'=>'Hora final de la jornada extra');
$n_label_ayuda[2]=array('texto'=>$columna[5],'exp'=>'Costo por hora de la jornada extra');
...
$m_label_ayuda[0]=array('texto'=>$columna[2],'exp'=>'Hora inicial de la jornada extra');
$m_label_ayuda[1]=array('texto'=>$columna[3],'exp'=>'Hora final de la jornada extra');
$m_label_ayuda[2]=array('texto'=>$columna[5],'exp'=>'Costo por hora de la jornada extra');
