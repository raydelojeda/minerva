...
$elemento_titulo="de criterio y evaluaciones"; // para el título
...
$opt_sel[$ff][0]='id_p';//selected del option, campo de la tabla externa de la consulta del combo, en caso que sea de forma estática se pone en uno solo "selected"
...
$opt_sel[$fff][0]='id_c';//selected del option, campo de la tabla externa de la consulta del combo, en caso que sea de forma estática se pone en uno solo "selected"
