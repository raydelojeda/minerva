...
$elemento_titulo="de tiempos de jornada extra"; // para el título
$elemento="jornada_extra"; // elemento o nomenclador al que se accede
...
$tabla="c_jornada_extra";// tabla de la BD

$tabla_anidada=array();
//$tabla_anidada[0]='n_jornada_extra';
//$tabla_anidada[1]='';
...
$field[0]='id_jornada_extra'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='extra_ini';
$field[2]='extra_fin';

$alias_col=array();
$alias_col[0]='id_jornada_extra';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='Inicio_jornada_extra';
$alias_col[2]='Fin_jornada_extra';

$columna[0]=''; // labels o encabezados, $field[0] es la llave de la tabla por tanto no lleva label (NO TOCAR)
$columna[1]='Inicio jornada extra';
$columna[2]='Fin jornada extra';
...
$l_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Inicio de jornada extra');
$l_label_ayuda[1]=array('texto'=>$columna[1],'exp'=>'Fin de jornada extra');
...
$insert_field[0]='id_jornada_extra'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='extra_ini'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
$insert_field[2]='extra_fin';
...
$ff=5;
$f=6;
$combo_sql[$f] = "select id_jornada_extra as id_emp, nombre_emp as emp from n_jornada_extra order by fecha_crea";
...
$n_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Inicio de jornada extra');
$n_label_ayuda[1]=array('texto'=>$columna[1],'exp'=>'Fin de jornada extra');
...
$m_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Inicio de jornada extra');
$m_label_ayuda[1]=array('texto'=>$columna[1],'exp'=>'Fin de jornada extra');
