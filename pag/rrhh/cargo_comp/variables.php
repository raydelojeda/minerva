...
$elemento_titulo="de las competencias seg&uacute;n el cargo"; // para el título
...
$opt_sel[$g][0]='id_ponderacion';//selected del option, campo de la tabla externa de la consulta del combo, en caso que sea de forma estática se pone en uno solo "selected"
