...
$elemento_titulo="de grupo de gastos"; // para el título
$elemento="grupo_gastos"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a los grupos de gastos registrados en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="n_grupo_gastos";// tabla de la BD

$tabla_anidada=array();
//$tabla_anidada[0]='n_grupo_gastos';
//$tabla_anidada[1]='';

$campo_anidado=array();
//$campo_anidado[0]='id_grupo_gastos';
//$campo_anidado[1]='';

$field[0]='id_grupo_gastos'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='grupo_gastos';

$alias_col=array();
$alias_col[0]='id_grupo_gastos';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='grupo_gastos';

$columna[0]=''; // labels o encabezados, $field[0] es la llave de la tabla por tanto no lleva label (NO TOCAR)
$columna[1]='Grupo de gastos';
...
$var_mod='';
$columna_suma[0]='';
$href_m='mod_grupo_gastos.php?mod='; // camino de la pagina para Editar
...
$l_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Grupo de gastos');
...
$l_botones[1]=array('target'=>'_self','href'=>'#','onclic'=>'modif(\'mod_grupo_gastos.php\')','src'=>$x.'img/general/Editar.png','nombre'=>'editar','texto'=>'Editar','accion'=>'Editar');
...
$insert_field[0]='id_grupo_gastos'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='grupo_gastos'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
...
$ff=5;
$f=6;
$combo_sql[$f] = "select id_grupo_gastos as id_emp, nombre_emp as emp from n_grupo_gastos order by fecha_crea";
...
$n_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Grupo de gastos');
...
$m_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Grupo de gastos');
