	...
	{				
		...
		<table align="center" width='100%'>
			...
			for($comp=0;$comp<$rs->RecordCount();$comp++)
			{
				...
				$rs->MoveNext();
				if($competencia!=$rs->fields['comp']){$total_c=0;$c=0;$t=$t+1;$total=bcadd($total,$resultado_comp,14);
				?>
					
					<tr>
						<td colspan='2' align="left" height="30"  width='100%'>
							<hr><?php print $competencia;?>: <b><?php print round($resultado_comp,2)." %";?></b>
						</td>	
					</tr>
					<?php }?>
