<?php
include("var_graf_colum_basica.php");
...
<table class="tabla_generica" align="center">
	...
	<?php 	
		if(isset($_POST['sel_empleado']) AND isset($_POST['sel_periodo_ini']))
		if($_POST['sel_empleado']!=0 AND $_POST['sel_periodo_ini']!=0)
		{
	?>
	<tr>
		<td align="right" >
...
<?php if(isset($_POST['sel_empleado']) AND isset($_POST['sel_periodo_ini']) AND $_POST['sel_empleado']!=0 AND $_POST['sel_periodo_ini']!=0){?>				
