...
$elemento_titulo="Evaluaci&oacute;n de desempe&ntilde;o de los subordinados de: ".$_SESSION['nombre']; // para el título
...
$titulo_listar=$elemento_titulo.": gr&aacute;fico"; //titulo del encabezado

//--------------------------------------------------------------------------

$titulo_graf='Evaluaci\u00f3n de desempe\u00f1o';
$subtitulo_graf='Evaluaci\u00f3n de las competencias o criterios en un momento dado';
