...
$elemento_titulo="de evaluaci&oacute;n de desempe&ntilde;o del personal";// los subordinados de: ".$_SESSION['nombre']; // para el título
...
AND emp.id_persona=per.id_persona AND emp.id_persona=usuario.id_persona";

$where.=" AND usuario='".$_SESSION['user']."' ORDER BY fecha_ini, ".$tabla_anidada2[0].".id_persona,".$tabla.".id_competencia, cod_criterio DESC";//die();
...
$columna[15]='Valor de evaluaci&oacute;n';
...
$l_botones[1]=array('target'=>'_self','href'=>'#','onclic'=>'seleccion(\'planilla_'.$elemento.'.php\')','src'=>$x.'img/general/pdf.png','nombre'=>'editar','texto'=>'Planilla','accion'=>'Imprimir');
$l_botones[2]=array('target'=>'_self','href'=>'#','onclic'=>'seleccion(\'planilla_resumen_desempeno.php\')','src'=>$x.'img/general/pdf.png','nombre'=>'editar','texto'=>'Resumen','accion'=>'Imprimir');
...
$l_botones[5]=array('target'=>'_self','href'=>'graf_colum_basica_'.$elemento.'.php','onclic'=>'','src'=>$x.'img/general/grafico_barra.png','nombre'=>'grafico','texto'=>'Gr&aacute;fico','accion'=>'Visualizar');
$l_botones[6]=array('target'=>'_self','href'=>'graf_linea_basica_'.$elemento.'.php','onclic'=>'','src'=>$x.'img/general/grafico.png','nombre'=>'grafico','texto'=>'Gr&aacute;fico','accion'=>'Visualizar');
...
$combo_sql[$ffffff] = "select id_evaluacion as id_evaluacion, concat(cod_evaluacion,' - ',evaluacion) as evaluacion from n_evaluacion ORDER BY cod_evaluacion ASC";
