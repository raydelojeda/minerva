...
$elemento_titulo="del cargo del empleado"; // para el título
$elemento="cargo_empleado"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a los cargos de los empleado registrados en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="cargo_empleado";// tabla de la BD

$tabla_anidada=array();
$tabla_anidada[0]='empleado';
$tabla_anidada[1]='n_cargo';
...
$campo_anidado[1]='id_cargo';

$field[0]=$tabla.'.id_cargo_empleado'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
...
$field_busqueda[5]='cargo';
$field_busqueda[6]='fecha_cargo';

$alias_col=array();
$alias_col[0]='ID_cargo_empleado';//alias de los campos de la consulta, debe haber alias en todos los campos
...
$insert_field[0]='id_cargo_empleado'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='id_empleado'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
$insert_field[2]='';
$insert_field[3]='id_cargo';
$insert_field[4]='';
$insert_field[5]='fecha_cargo';
