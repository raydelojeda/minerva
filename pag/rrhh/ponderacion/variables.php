...
$elemento_titulo="de ponderaci&oacute;n"; // para el título
$elemento="ponderacion"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a las ponderaciones registradas en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="n_ponderacion";// tabla de la BD

$tabla_anidada=array();
//$tabla_anidada[0]='grupo_pond';
//$tabla_anidada[1]='';

$campo_anidado=array();
//$campo_anidado[0]='id_grupo_pond';
//$campo_anidado[1]='';

$field[0]='id_ponderacion'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='cod_ponderacion';
$field[2]='ponderacion';
$field[3]='valor_p';
$field[4]='exp_pond';

$alias_col=array();
$alias_col[0]='id_ponderacion';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='cod_ponderacion';
$alias_col[2]='ponderacion';
$alias_col[3]='valor';
$alias_col[4]='exp_ponderacion';

$columna[0]=''; // labels o encabezados, $field[0] es la llave de la tabla por tanto no lleva label (NO TOCAR)
$columna[1]='C&oacute;digo';
$columna[2]='Ponderaci&oacute;n';
$columna[3]='Valor';
$columna[4]='Explicaci&oacute;n de ponderaci&oacute;n';
...
$l_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'C&oacute;digo de ponderaci&oacute;n a evaluar');
$l_label_ayuda[1]=array('texto'=>$columna[2],'exp'=>'Ponderaci&oacute;n a evaluar');
$l_label_ayuda[2]=array('texto'=>$columna[3],'exp'=>'Valor de ponderaci&oacute;n a evaluar');
$l_label_ayuda[3]=array('texto'=>$columna[4],'exp'=>'Explicaci&oacute;n de ponderaci&oacute;n a evaluar');
...
$insert_field[0]='id_ponderacion'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='cod_ponderacion'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
$insert_field[2]='ponderacion';
$insert_field[3]='valor_p';
$insert_field[4]='exp_pond';
...
$ff=5;
$f=6;
$combo_sql[$f] = "select id_grupo_pond as id_p, grupo_pond as grupo_pond from grupo_pond";

$opt_name=array();
$opt_name[$f][0]='grupo_pond';//dato que va a mostrar al usuario ejem: Elemento 1, Elemento 2, etc. otro: Administrador, Vendedor, Contador, Invitado, etc. 
...
$n_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'C&oacute;digo de ponderaci&oacute;n a evaluar');
$n_label_ayuda[1]=array('texto'=>$columna[2],'exp'=>'Ponderaci&oacute;n a evaluar');
$n_label_ayuda[2]=array('texto'=>$columna[3],'exp'=>'Valor de ponderaci&oacute;n a evaluar');
$n_label_ayuda[3]=array('texto'=>$columna[4],'exp'=>'Explicaci&oacute;n de ponderaci&oacute;n a evaluar');
...
$m_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'C&oacute;digo de ponderaci&oacute;n a evaluar');
$m_label_ayuda[1]=array('texto'=>$columna[2],'exp'=>'Ponderaci&oacute;n a evaluar');
$m_label_ayuda[2]=array('texto'=>$columna[3],'exp'=>'Valor de ponderaci&oacute;n a evaluar');
$m_label_ayuda[3]=array('texto'=>$columna[4],'exp'=>'Explicaci&oacute;n de ponderaci&oacute;n a evaluar');
