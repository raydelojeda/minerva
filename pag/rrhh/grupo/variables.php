...
$elemento_titulo="de grupo seg&uacute;n la jornada"; // para el título
$elemento="grupo"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a los grupos de empleados seg&uacute;n la jornada, registrados en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="n_grupo";// tabla de la BD
...
$field[0]='id_grupo'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='grupo';

$alias_col=array();
$alias_col[0]='id_grupo';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='grupo';

$columna[0]=''; // labels o encabezados, $field[0] es la llave de la tabla por tanto no lleva label (NO TOCAR)
$columna[1]='Grupo seg&uacute;n la jornada';
...
$var_mod='';
$columna_suma[0]='';
$href_m='mod_grupo.php?mod='; // camino de la pagina para Editar
...
$l_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Grupo seg&uacute;n la jornada');
...
$l_botones[1]=array('target'=>'_self','href'=>'#','onclic'=>'modif(\'mod_grupo.php\')','src'=>$x.'img/general/Editar.png','nombre'=>'editar','texto'=>'Editar','accion'=>'Editar');
...
$insert_field[0]='id_grupo'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='grupo'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
...
$ff=5;
$f=6;
$combo_sql[$f] = "select id_grupo as id_emp, nombre_emp as emp from n_grupo order by fecha_crea";
...
$n_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Grupo seg&uacute;n la jornada');
...
$m_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Grupo seg&uacute;n la jornada');
