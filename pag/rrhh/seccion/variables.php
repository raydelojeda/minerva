...
$elemento="seccion"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a las secciones registradas en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="n_seccion";// tabla de la BD

$tabla_anidada=array();
//$tabla_anidada[0]='n_seccion';
//$tabla_anidada[1]='';

$campo_anidado=array();
//$campo_anidado[0]='id_seccion';
//$campo_anidado[1]='';

$field[0]='id_seccion'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='seccion';

$alias_col=array();
$alias_col[0]='id_seccion';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='seccion';
...
$var_mod='';
$columna_suma[0]='';
$href_m='mod_seccion.php?mod='; // camino de la pagina para Editar
...
$l_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Secci&oacute;n');
...
$l_botones[1]=array('target'=>'_self','href'=>'#','onclic'=>'modif(\'mod_seccion.php\')','src'=>$x.'img/general/Editar.png','nombre'=>'editar','texto'=>'Editar','accion'=>'Editar');
...
$insert_field[0]='id_seccion'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='seccion'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
...
$ff=5;
$f=6;
$combo_sql[$f] = "select id_seccion as id_emp, nombre_emp as emp from n_seccion order by fecha_crea";
...
$n_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Secci&oacute;n');
...
$m_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Secci&oacute;n');
