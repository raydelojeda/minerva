...
$elemento_titulo="de historial de empleado"; // para el título
$elemento="empleado"; // elemento o nomenclador al que se accede
...
$where=' AND empleado.id_cargo_jefe=n_cargo.id_cargo';
...
$field_busqueda[6]='email_inst';
$field_busqueda[7]="inst_educativa";
...
$columna[24]='No biom&eacute;trico';
...
$texto_input[8]='<a href="#modal_dpto"><img src="'.$x.'img/general/agregar.png";></a>';
$texto_input[12]='<a href="#modal_tit"><img src="'.$x.'img/general/agregar.png";></a>';
$texto_input[14]='<a href="#modal_inst"><img src="'.$x.'img/general/agregar.png";></a>';
