...
$elemento_titulo="de costo de horas extras"; // para el título
$elemento="costo_horas_extras"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a los costos de horas extras registrados en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="c_costo_horas_extras";// tabla de la BD

$tabla_anidada=array();
//$tabla_anidada[0]='n_costo_horas_extras';
//$tabla_anidada[1]='';

$campo_anidado=array();
//$campo_anidado[0]='id_costo_horas_extras';
//$campo_anidado[1]='';

$field[0]='id_costo_horas_extras'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='costo';

$alias_col=array();
$alias_col[0]='id_costo_horas_extras';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='costo';

$columna[0]=''; // labels o encabezados, $field[0] es la llave de la tabla por tanto no lleva label (NO TOCAR)
$columna[1]='Costo de horas extras';
...
$var_mod='';
$columna_suma[0]='';
$href_m='mod_costo_horas_extras.php?mod='; // camino de la pagina para Editar
...
$l_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Costo de horas extras');
...
$insert_field[0]='id_costo_horas_extras'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='costo'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
...
$ff=5;
$f=6;
$combo_sql[$f] = "select id_costo_horas_extras as id_emp, nombre_emp as emp from n_costo_horas_extras order by fecha_crea";
...
$n_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Costo de horas extras');
...
$m_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Costo de horas extras');
