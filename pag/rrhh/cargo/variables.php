...
$elemento_titulo="de cargo"; // para el título
$elemento="cargo"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a los cargos registradas en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="n_cargo";// tabla de la BD
...
$field[0]='id_cargo'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='cargo';

$alias_col=array();
$alias_col[0]='id_cargo';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='cargo';
...
$var_mod='';
$columna_suma[0]='';
$href_m='mod_cargo.php?mod='; // camino de la pagina para Editar
...
$l_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Cargo de la persona');
...
$insert_field[0]='id_cargo'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='cargo'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
...
$ff=5;
$f=6;
$combo_sql[$f] = "select id_cargo as id_emp, nombre_emp as emp from n_cargo order by fecha_crea";
...
$n_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Cargo de la persona');
...
$m_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Cargo de la persona');
