...
$elemento_titulo="de cargo que autoriza a un empleado a tomar permisos"; // para el título
...
$opt_sel=array();
$opt_sel[$f][0]='ID_CARGO';//selected del option, campo de la tabla externa de la consulta del combo, en caso que sea de forma estática se pone en uno solo "selected"
...
$opt_sel[$ff][0]='ID_CAR';//selected del option, campo de la tabla externa de la consulta del combo, en caso que sea de forma estática se pone en uno solo "selected"
