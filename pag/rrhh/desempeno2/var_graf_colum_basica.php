...
$elemento_titulo="de la evaluaci&oacute;n de desempe&ntilde;o de: ".$_SESSION['nombre']; // para el título
...
if(isset($_POST['sel_competencia']) AND isset($_POST['sel_criterio']))
{
	...
	$rs_comp_cri=$db->Execute($sql_comp_cri) or die($db->ErrorMsg());//print $rs_comp_cri;
}
...
if(isset($_POST['sel_periodo_ini']) AND isset($_POST['sel_competencia']) AND $_POST['sel_competencia']!='0')
{
	...
	if(isset($_POST['txt_id_evaluado']) AND $_POST['txt_id_evaluado']!=0)$from_y=$from_y." AND desempeno.id_empleado = '".$_POST['txt_id_evaluado']."'";
