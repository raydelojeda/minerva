...
$elemento_titulo="de solicitud de ausencia o permiso sin revisar de: ".$_SESSION['nombre']; // para el título
...
$tabla_anidada2[1]='usuario';

$campo_anidado2[0]='id_persona';

$where=" AND empleado.id_persona=persona.id_persona AND empleado.id_persona=usuario.id_persona";
