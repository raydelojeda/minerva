...
$elemento_titulo="de grupo de evaluaciones"; // para el título
$elemento="grupo_eval"; // elemento o nomenclador al que se accede
...
$tabla="grupo_eval";// tabla de la BD

$tabla_anidada=array();
//$tabla_anidada[0]='n_evaluacion';

$campo_anidado=array();
//$campo_anidado[0]='id_evaluacion';

$field[0]='id_grupo_eval'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='grupo_eval';

$alias_col=array();
$alias_col[0]='id_grupo_eval';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='gru';
...
$var_mod='';
$columna_suma[0]='';
$href_m='mod_grupo_eval.php?mod='; // camino de la pagina para Editar
...
$l_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Grupo de criterios y evaluaciones');
...
$insert_field[0]='id_grupo_eval'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='grupo_eval'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
...
$f=5;
$ff=2;
$combo_sql[$f] = "select id_criterio as id_c, concat(cod_criterio,' - ',criterio) as criterio from n_criterio";

$opt_name=array();
$opt_name[$f][0]='criterio';//dato que va a mostrar al usuario ejem: Elemento 1, Elemento 2, etc. otro: Administrador, Vendedor, Contador, Invitado, etc. 
...
$combo_sql[$ff] = "select id_evaluacion as id_e, concat(cod_evaluacion,' - ',evaluacion) as evaluacion from n_evaluacion";

$opt_name[$ff][0]='evaluacion';//dato que va a mostrar al usuario ejem: Elemento 1, Elemento 2, etc. otro: Administrador, Vendedor, Contador, Invitado, etc. 
$opt_name[$ff][1]='';//Además puedes tener del campo de la tabla en caso de selectBD
$opt_name[$ff][2]='';
$opt_name[$ff][3]='';


$opt_value[$ff][0]='id_e';//value del option, campo de la tabla externa de la consulta del combo
$opt_value[$ff][1]='';
$opt_value[$ff][2]='';
$opt_value[$ff][3]='';


$opt_sel[$ff][0]='id_e';//selected del option, campo de la tabla externa de la consulta del combo, en caso que sea de forma estática se pone en uno solo "selected"
...
$n_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Grupo de criterios y evaluaciones');
...
$m_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Grupo de criterios y evaluaciones');
