...
$elemento_titulo="de perfil de usuario"; // para el título
$elemento="perfil"; // elemento o nomenclador al que se accede
$camino="pag/perf/".$elemento; // camino para acceder
$location=$x.$camino;

$img_encabezado="img/perf/".$elemento."/".$elemento.".png"; //imagen del encabezado
...
$where.="AND persona.id_persona=usuario.id_persona AND usuario='".$_SESSION['user']."'";//die();
...
$m_botones[1]=array('target'=>'_self','href'=>'../../panel/panel.php?modulo=mod','onclic'=>'','src'=>$x.'img/general/cancelar.png','nombre'=>'cancelar','texto'=>'Salir','accion'=>'');
