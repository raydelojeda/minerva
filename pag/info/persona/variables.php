...
$camino="pag/info/".$elemento; // camino para acceder
$location=$x.$camino;

$img_encabezado="img/info/".$elemento."/".$elemento.".png"; //imagen del encabezado
...
$ffff=11;
$t=19;
$combo_sql[$f] = "select id_pais as id_p, pais as pais from n_pais ORDER BY pais ASC";
...
$combo_sql[$ff] = "select id_genero as id_g, genero as genero from n_genero ORDER BY genero ASC";
...
$combo_sql[$fff] = "select id_tipo_sangre as id_t, tipo_sangre as tipo_sangre from n_tipo_sangre ORDER BY tipo_sangre ASC";
...
$combo_sql[$t] = "select id_tipo_identificacion as id_i, tipo_identificacion as tide from n_tipo_identificacion ORDER BY tide ASC";
...
if(isset($_GET['ident']))$value_input[1]=$_GET['ident'];else $value_input[1]='';
$value_input[2]='';
$value_input[3]='';
$value_input[4]='';
$value_input[5]='';
