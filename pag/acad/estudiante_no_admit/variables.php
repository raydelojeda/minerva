...
$inputs21=$obj_var->Llenar_inputs($tipo_input,$name_input,$value_input,$columna,$label_input,$dato_permit,$onclic,$size,$field_col,$texto_input,$placeholder,$evento);// para llenar los input (NO TOCAR)
...
$elemento_titulo=" admitido en el per&iacute;odo actual"; // para el título
$elemento="estudiante_no_admit"; // elemento o nomenclador al que se accede
$camino="pag/acad/".$elemento; // camino para acceder
$location=$x.$camino;

$img_encabezado="img/acad/".$elemento."/".$elemento.".png"; //imagen del encabezado

$titulo_listar="Administraci&oacute;n de estudiante no".$elemento_titulo.": listar"; //titulo del encabezado
$titulo_nuevo="Administraci&oacute;n de estudiante".$elemento_titulo.": insertar"; //titulo del encabezado
$titulo_editar="Administraci&oacute;n de estudiante".$elemento_titulo.": editar"; //titulo del encabezado
$titulo_ayuda="Administraci&oacute;n de estudiante no".$elemento_titulo.": ayuda"; //titulo del encabezado
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a los estudiantes no admitidos registrados en la base de datos.";//introduccion de la ayuda
...
AND n_tipo_identificacion.id_tipo_identificacion=persona.id_tipo_identificacion
...
//AND NOT EXISTS (SELECT 1 FROM curso_grado_paralelo_est WHERE 1 AND curso_grado_paralelo_est.id_estudiante = estudiante.id_estudiante AND retirado="1")';
...
$l_label_ayuda[25]=array('texto'=>$columna[24],'exp'=>'Foto del estudiante');
...
$onsubmit=$onsubmit.','.$obj_var->Llenar_varios_onsubmit($inputs21);// para llenar la variable $onsubmit con la funcion en js con los parametros del id del input y el dato permitido (NO TOCAR)
...
$n_label_ayuda[25]=array('texto'=>$columna[24],'exp'=>'Foto del estudiante');
...
$m_label_ayuda[25]=array('texto'=>$columna[24],'exp'=>'Foto del estudiante');
