...
$alias_col[1]='id_clasee_mod';
$alias_col[2]='clasee_mod';
$alias_col[3]='id_ss_mod';
$alias_col[4]='subp_mod';
$alias_col[5]='fechaa_mod';
...
$sql_sub="SELECT n_subperiodo_evaluativo.id_subperiodo_evaluativo AS id_ss_mod, concat(subperiodo_evaluativo,' (',abv_subperiodo,')') as subp_mod
...
$opt_name=array();
$opt_name[$f][0]='subp_mod';//dato que va a mostrar al persona ejem: Elemento 1, Elemento 2, etc. otro: Administrador, Vendedor, Contador, Invitado, etc. 
$opt_name[$f][1]='';//Además puedes tener del campo de la tabla en caso de selectBD
$opt_name[$f][2]='';
$opt_name[$f][3]='';

$opt_value=array();
$opt_value[$f][0]='id_ss_mod';//value del option, campo de la tabla externa de la consulta del combo
$opt_value[$f][1]='';
$opt_value[$f][2]='';
$opt_value[$f][3]='';

$opt_sel=array();
$opt_sel[$f][0]='id_ss_mod';//selected del option, campo de la tabla externa de la consulta del combo, en caso que sea de forma estática se pone en uno solo "selected"
...
$mini_onsubmit=$mini_onsubmit.");";//print $mini_onsubmit;

$campos_origen=array();
$campos_origen[0]='hdn_id_clase';//id_clase
$campos_origen[1]=$name_input[4];//id_tipo
$campos_origen[2]=$name_input[5];//fec
$campos_origen[3]=$name_input[6];//tema
$campos_origen[4]='sel_filtro_asis';
$campos_origen[5]='hdn_id_clase_inasistencia_mod';

$mini_m_botones=array(); // botonera que va a tener en el encabezado (NO TOCAR)
$mini_m_botones[0]=array('target'=>'_self','href'=>'#','onclic'=>$mini_onsubmit."if(ok==0)return false;ejecutar_ajax('asistencia/mod_".$elemento.".php','".implode(",", $campos_origen)."','contenido_grid_asistencias');",'src'=>'../../../img/general/guardar_mini.png','nombre'=>'guardar','texto'=>'Guardar','accion'=>'Insertar');
$mini_m_botones[1]=array('target'=>'_self','href'=>'#close','onclic'=>'','src'=>'../../../img/general/cerrar_mini.png','nombre'=>'cancelar','texto'=>'Salir','accion'=>'');
