...
$elemento_titulo="del grado y paralelo"; // para el título
...
$opt_sel[$ff][0]='id_tipo_grado';//selected del option, campo de la tabla externa de la consulta del combo, en caso que sea de forma estática se pone en uno solo "selected"
...
$opt_sel[$g][0]='id_paralelo';//selected del option, campo de la tabla externa de la consulta del combo, en caso que sea de forma estática se pone en uno solo "selected"
...
$opt_sel[$gs][0]='id_responsable_acta';//selected del option, campo de la tabla externa de la consulta del combo, en caso que sea de forma estática se pone en uno solo "selected"
