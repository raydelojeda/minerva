...
$elemento_titulo="de secci&oacute;n acad&eacute;mica"; // para el título
$elemento="seccion_academica"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a las secciones acad&eacute;micas registradas en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="n_seccion_academica";// tabla de la BD
...
$field[0]='id_seccion_academica'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='seccion_academica';
$field[2]='abreviatura';
$field[3]='orden';

$alias_col=array();
$alias_col[0]='id_seccion_academica';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='secc';
$alias_col[2]='abre';
$alias_col[3]='orden';

$columna[0]=''; // labels o encabezados, $field[0] es la llave de la tabla por tanto no lleva label (NO TOCAR)
$columna[1]='Secci&oacute;n acad&eacute;mica';
...
$l_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Secci&oacute;n acad&eacute;mica: "Educaci&oacute; Inicial, Elemental B&aacute;sica, etc."');
$l_label_ayuda[1]=array('texto'=>$columna[2],'exp'=>'Abreviatura');
$l_label_ayuda[2]=array('texto'=>$columna[3],'exp'=>'Orden');
...
$insert_field[0]='id_seccion_academica'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='seccion_academica'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
...
$ff=5;
$f=6;
$combo_sql[$f] = "select id_seccion_academica as id_emp, nombre_emp as emp from n_seccion_academica order by fecha_crea";
...
$n_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Secci&oacute;n acad&eacute;mica: "Educaci&oacute; Inicial, Elemental B&aacute;sica, etc."');
$n_label_ayuda[1]=array('texto'=>$columna[2],'exp'=>'Abreviatura');
$n_label_ayuda[2]=array('texto'=>$columna[3],'exp'=>'Orden');
...
$m_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Secci&oacute;n acad&eacute;mica: "Educaci&oacute; Inicial, Elemental B&aacute;sica, etc."');
$m_label_ayuda[1]=array('texto'=>$columna[2],'exp'=>'Abreviatura');
$m_label_ayuda[2]=array('texto'=>$columna[3],'exp'=>'Orden');
