...
$texto_input=array();$placeholder=array();$evento=array();
...
//$n_botones[0]=array('target'=>'_self','href'=>'#','onclic'=>'','src'=>$x.'img/general/nuevo.png','nombre'=>'nuevo','texto'=>'Actividad','accion'=>'Insertar');
...
//$n_botones[1]=array('target'=>'_blank','href'=>$x.'plantillas/ayu_insertar.php?var='.$camino.'/variables.php','onclic'=>'','src'=>$x.'img/general/ayuda.png','nombre'=>'ayuda','texto'=>'Ayuda','accion'=>'');

$n_botones_ayuda=array(); // botonera que va a tener en el encabezado (NO TOCAR) 
$n_botones_ayuda[0]=array('texto'=>'Insertar','exp'=>'insertar una actividad');
