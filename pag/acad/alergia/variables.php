...
$elemento_titulo="de alergia"; // para el título
$elemento="alergia"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a las alergias registradas en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="n_alergia";// tabla de la BD

$tabla_anidada=array();
//$tabla_anidada[0]='n_alergia';
//$tabla_anidada[1]='';

$campo_anidado=array();
//$campo_anidado[0]='id_alergia';
//$campo_anidado[1]='';

$field[0]='id_alergia'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='alergia';

$alias_col=array();
$alias_col[0]='id_alergia';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='gra';
...
$var_mod='';
$columna_suma[0]='';
$href_m='mod_alergia.php?mod='; // camino de la pagina para Editar
...
$l_botones[1]=array('target'=>'_self','href'=>'#','onclic'=>'modif(\'mod_alergia.php\')','src'=>$x.'img/general/Editar.png','nombre'=>'editar','texto'=>'Editar','accion'=>'Editar');
...
$insert_field[0]='id_alergia'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='alergia'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
...
$ff=5;
$f=6;
$combo_sql[$f] = "select id_alergia as id_emp, nombre_emp as emp from n_alergia order by fecha_crea";
