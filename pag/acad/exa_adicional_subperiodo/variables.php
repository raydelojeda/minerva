...
$elemento_titulo="de examen adicional del subper&iacute;odo evaluativo (Parcial)"; // para el título
$elemento="exa_adicional_subperiodo"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto al examen adicional del subper&ioacute;odo evaluativo, registrados en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="n_exa_adicional_subperiodo";// tabla de la BD

$tabla_anidada=array();
$tabla_anidada[0]='n_tipo_actividad';
$tabla_anidada[1]='n_examen_adicional';
$tabla_anidada[2]='n_tipo_examen';

$campo_anidado=array();
$campo_anidado[0]='id_tipo_actividad';
...
$tabla_anidada2[4]='n_subperiodo_evaluativo';
...
$campo_anidado2[4]='id_subperiodo_evaluativo';

$where=' AND n_asignatura.id_asignatura=n_tipo_actividad.id_asignatura AND n_subperiodo_evaluativo.id_subperiodo_evaluativo=n_tipo_actividad.id_subperiodo_evaluativo 
...
AND n_periodo_lectivo.id_conf_academica=n_conf_academica.id_conf_academica AND n_conf_academica.activa="1"';

$field[0]=$tabla.'.id_exa_adicional_subperiodo'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]=$tabla.'.id_examen_adicional';
$field[2]="concat(abv_examen,' - ',examen_adicional)";
$field[3]=$tabla.'.id_tipo_examen';
$field[4]="tipo_examen";
$field[5]=$tabla.'.id_tipo_actividad';
$field[6]="concat(subperiodo_evaluativo,' - ',asignatura,' - ',tipo_actividad_examen)";
...
$alias_col[5]='id_tipo_actividad';
$alias_col[6]='tipo_actividad_examen_asignatura';
...
$l_botones[0]=array('target'=>'_self','href'=>'new_exa_adicional_subperiodo2.php','onclic'=>'','src'=>$x.'img/general/nuevo.png','nombre'=>'nuevo','texto'=>'Gestionar','accion'=>'Insertar');
...
$insert_field[0]='id_exa_adicional_subperiodo'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
...
$insert_field[4]='';
$insert_field[5]='id_tipo_actividad';
$insert_field[6]='';
...
$label_input[6]='Examen subper&iacute;odo y asignatura';
$label_input[7]='Se publica la nota del examen?';
$label_input[8]='Sustituye la nota del subper&iacute;odo evaluativo?';
...
$combo_sql[$r] = "SELECT id_tipo_actividad as id_tipo_actividad, concat(subperiodo_evaluativo,' - ',asignatura,' - ',tipo_actividad_examen) as tipo_actividad_examen_asignatura
...
$opt_name[$r][0]='tipo_actividad_examen_asignatura';//dato que va a mostrar al usuario ejem: Elemento 1, Elemento 2, etc. otro: Administrador, Vendedor, Contador, Invitado, etc. //Además puedes tener del campo de la tabla en caso de selectBD
$opt_value[$r][0]='id_tipo_actividad';//value del option, campo de la tabla externa de la consulta del combo
$opt_sel[$r][0]='id_tipo_actividad';//selected del option, campo de la tabla externa de la consulta del combo, en caso que sea de forma estática se pone en uno solo "selected"// cuando sea selecBD en la primera fila se pone el alias del id de la tabla externa asociada al selecBD
...
$texto_input[8]='Si es "Si" ser&iacute;a la nota del subper&iacute;odo. Si es "No" se calcular&iacute;a la nota del subper&iacute;odo evaluativo seg&uacute;n los pesos.';
