...
include_once($x."pag/clases_pag.php");
if(!isset($obj2))$obj2 = new clases_extras();// (NO TOCAR)
...
$elemento_titulo="del clase y estudiante"; // para el título
...
$field_busqueda[5]='n_periodo_academico.nombre';
$field_busqueda[6]='abreviatura';
$field_busqueda[7]='asignatura';
$field_busqueda[8]="referencia";
$field_busqueda[9]=$tabla.'.nombre';
$field_busqueda[10]='codigo';
$field_busqueda[8]="codigo_unico";
