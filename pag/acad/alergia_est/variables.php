...
/*$campo_anidado2[0]='id_alergia_est';
$campo_anidado2[1]='id_alergia';
...
AND n_enfermedad.id_alergia=enfermedad_est.id_alergia
...
//------------------------------------------------INSERTAR------------------------------------------------
$insert_field=array();
$insert_field[0]='id_alergia_est'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='id_datos_clinicos'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
$insert_field[2]='';
$insert_field[3]='id_alergia';
$insert_field[4]='';
$insert_field[5]='reaccion';
$insert_field[6]='descripcion';

$insert_alias=array();
$insert_alias[0]='id_alergia_est'; //alias de los campos de la consulta, debe haber alias en todos los campos
$insert_alias[1]='id_datos_clinicos';
$insert_alias[2]='datos';
$insert_alias[3]='id_alergia';
$insert_alias[4]='alergia';
$insert_alias[5]='reaccion';
$insert_alias[6]='descripcion_alergia';
...
$name_input[3]=$insert_alias[4];
$name_input[4]=$insert_alias[4];
$name_input[5]=$insert_alias[5];
$name_input[6]=$insert_alias[6];
...
$label_input[2]='';
$label_input[3]='Alergia';
$label_input[4]='Alergia';
$label_input[5]='Reacci&oacute;n';
$label_input[6]='Descripci&oacute;n';
...
$combo_sql[$f] = "select id_alergia as id_alergia, alergia as alergia 
FROM n_alergia ORDER BY alergia";

$opt_name=array();
$opt_name[$f][0]='alergia';//dato que va a mostrar al usuario ejem: Elemento 1, Elemento 2, etc. otro: Administrador, Vendedor, Contador, Invitado, etc. 
$opt_name[$f][1]='';//Además puedes tener del campo de la tabla en caso de selectBD
$opt_name[$f][2]='';
$opt_name[$f][3]='';

$opt_value=array();
$opt_value[$f][0]='id_alergia';//value del option, campo de la tabla externa de la consulta del combo
$opt_value[$f][1]='';
$opt_value[$f][2]='';
$opt_value[$f][3]='';

$opt_sel=array();
$opt_sel[$f][0]='id_alergia';//selected del option, campo de la tabla externa de la consulta del combo, en caso que sea de forma estática se pone en uno solo "selected"
