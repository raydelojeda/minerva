...
$elemento_titulo="de vacuna"; // para el título
$elemento="vacuna"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a las vacunas en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="n_vacuna";// tabla de la BD

$tabla_anidada=array();
//$tabla_anidada[0]='n_vacuna';
//$tabla_anidada[1]='';

$campo_anidado=array();
//$campo_anidado[0]='id_vacuna';
//$campo_anidado[1]='';

$field[0]='id_vacuna'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='vacuna';

$alias_col=array();
$alias_col[0]='id_vacuna';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='gra';
...
$var_mod='';
$columna_suma[0]='';
$href_m='mod_vacuna.php?mod='; // camino de la pagina para Editar
...
$l_botones[1]=array('target'=>'_self','href'=>'#','onclic'=>'modif(\'mod_vacuna.php\')','src'=>$x.'img/general/Editar.png','nombre'=>'editar','texto'=>'Editar','accion'=>'Editar');
...
$insert_field[0]='id_vacuna'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='vacuna'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
...
$ff=5;
$f=6;
$combo_sql[$f] = "select id_vacuna as id_emp, nombre_emp as emp from n_vacuna order by fecha_crea";
