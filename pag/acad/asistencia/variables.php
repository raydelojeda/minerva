...
$elemento_titulo="de asistencia"; // para el título
$elemento="asistencia"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a las asistencias registradas en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="n_asistencia";// tabla de la BD

$tabla_anidada=array();
//$tabla_anidada[0]='n_asistencia';
//$tabla_anidada[1]='';

$campo_anidado=array();
//$campo_anidado[0]='id_asistencia';
//$campo_anidado[1]='';

$field[0]='id_asistencia'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='asistencia';
$field[2]='justifica';

$alias_col=array();
$alias_col[0]='id_asistencia';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='asistencia';
$alias_col[2]='justifica';

$columna[0]=''; // labels o encabezados, $field[0] es la llave de la tabla por tanto no lleva label (NO TOCAR)
$columna[1]='Asistencia';
$columna[2]='Se justifica';
...
$l_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Asistencia');
$l_label_ayuda[1]=array('texto'=>$columna[1],'exp'=>'Se justifica: Si o No');
...
$insert_field[0]='id_asistencia'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='asistencia'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
$insert_field[2]='justifica';
...
$n_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Asistencia');
$n_label_ayuda[1]=array('texto'=>$columna[1],'exp'=>'Se justifica: Si o No');
...
$m_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Asistencia');
$m_label_ayuda[1]=array('texto'=>$columna[1],'exp'=>'Se justifica: Si o No');
