...
$sql_left="SELECT id_examen_periodo_eval as id_left, concat(examen_eval,' - ',asignatura) as leeft
...
for($top=0;$top<$rs_top->RecordCount();$top++)
{
	...
	for($left=0;$left<$rs_left->RecordCount();$left++)
	{
		...
		if(isset($_POST[$cbx]))
		{
			...
			{
				$i_sql="INSERT INTO n_exa_adicional_periodo(id_examen_adicional, id_tipo_examen, id_examen_periodo_eval, publica_nota, sustituye_nota, orden) 
