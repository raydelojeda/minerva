...
$elemento_titulo="de examen o tipo de actividad del subper&iacute;odo evaluativo (Parcial)"; // para el título
$elemento="tipo_actividad"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto al examen o actividad del per&ioacute;odo evaluativo registrados en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="n_tipo_actividad";// tabla de la BD

$tabla_anidada=array();
$tabla_anidada[0]='n_subperiodo_evaluativo';
$tabla_anidada[1]='n_asignatura';

$campo_anidado=array();
$campo_anidado[0]='id_subperiodo_evaluativo';
$campo_anidado[1]='id_asignatura';

$tabla_anidada2=array();
$tabla_anidada2[0]='n_conf_academica';
$tabla_anidada2[1]='n_periodo_lectivo';
$tabla_anidada2[2]='n_periodo_evaluativo';

$campo_anidado2=array();
$campo_anidado2[0]='id_conf_academica';
$campo_anidado2[1]='id_periodo_lectivo';
$campo_anidado2[2]='id_periodo_evaluativo';

$where=' AND n_subperiodo_evaluativo.id_periodo_evaluativo=n_periodo_evaluativo.id_periodo_evaluativo AND n_periodo_lectivo.id_periodo_lectivo=n_periodo_evaluativo.id_periodo_lectivo AND n_periodo_lectivo.id_conf_academica=n_conf_academica.id_conf_academica AND n_conf_academica.activa="1"';

$field[0]=$tabla.'.id_tipo_actividad'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]=$tabla.'.id_subperiodo_evaluativo';
$field[2]="subperiodo_evaluativo";
$field[3]=$tabla.'.id_asignatura';
$field[4]="concat(abreviatura,' - ',asignatura)";
$field[5]='tipo_actividad_examen';
$field[6]='abv_tipo_actividad_examen';
$field[7]='peso';
$field[8]='visualizan_ppff';
$field[9]='orden';

$alias_col=array();
$alias_col[0]='id_tipo_actividad';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='id_subperiodo_evaluativo';
$alias_col[2]='subperiodo_evaluativo';
$alias_col[3]='id_asignatura';
$alias_col[4]='asignatura';
$alias_col[5]='tipo_actividad_examen';
$alias_col[6]='abv_tipo_actividad_examen';
$alias_col[7]='peso';
$alias_col[8]='visualizan_ppff';
$alias_col[9]='orden';

$columna[0]=''; // labels o encabezados, $field[0] es la llave de la tabla por tanto no lleva label (NO TOCAR)
$columna[1]='Per&iacute;odo evaluativo';
$columna[2]='Per&iacute;odo evaluativo';
$columna[3]='Asignatura';
$columna[4]='Asignatura';
$columna[5]='Examen o Tipo de actividad';
$columna[6]='Abreviatura';
$columna[7]='Peso';
$columna[8]='Visualizan PPFF';
$columna[9]='Orden';
...
$l_label_ayuda[0]=array('texto'=>$columna[2],'exp'=>'Per&iacute;odo evaluativo');
$l_label_ayuda[1]=array('texto'=>$columna[4],'exp'=>'Asignatura');
$l_label_ayuda[2]=array('texto'=>$columna[5],'exp'=>'Examen evaluativo');
$l_label_ayuda[3]=array('texto'=>$columna[6],'exp'=>'Abreviatura');
$l_label_ayuda[4]=array('texto'=>$columna[7],'exp'=>'Peso');
$l_label_ayuda[5]=array('texto'=>$columna[8],'exp'=>'Visualizan los padres de familia? Si o No (Se utiliza para la visualizaci&oacuten de deberes');
$l_label_ayuda[6]=array('texto'=>$columna[9],'exp'=>'Orden del tipo de actividad o examen dentro de los cuadernos de clase');

$l_botones=array(); // botonera para listar que va a tener en el encabezado (NO TOCAR)
$l_botones[0]=array('target'=>'_self','href'=>'new_tipo_actividad2.php','onclic'=>'','src'=>$x.'img/general/nuevo.png','nombre'=>'nuevo','texto'=>'Gestionar','accion'=>'Insertar');
...
$insert_field[0]='id_tipo_actividad'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='id_subperiodo_evaluativo'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
$insert_field[2]='';
$insert_field[3]='id_asignatura';
$insert_field[4]='';
$insert_field[5]='tipo_actividad_examen';
$insert_field[6]='abv_tipo_actividad_examen';
$insert_field[7]='peso';
$insert_field[8]='visualizan_ppff';
...
$combo_sql[$e] = "SELECT n_subperiodo_evaluativo.id_subperiodo_evaluativo as id_subperiodo_evaluativo, concat(periodo_evaluativo,' - ',subperiodo_evaluativo,' (',abv_subperiodo,')') as subperiodo_evaluativo 
...
$opt_name[$e][0]='subperiodo_evaluativo';//dato que va a mostrar al usuario ejem: Elemento 1, Elemento 2, etc. otro: Administrador, Vendedor, Contador, Invitado, etc. //Además puedes tener del campo de la tabla en caso de selectBD
$opt_value[$e][0]='id_subperiodo_evaluativo';//value del option, campo de la tabla externa de la consulta del combo
$opt_sel[$e][0]='id_subperiodo_evaluativo';//selected del option, campo de la tabla externa de la consulta del combo, en caso que sea de forma estática se pone en uno solo "selected"// cuando sea selecBD en la primera fila se pone el alias del id de la tabla externa asociada al selecBD
...
$opt_name[$p][0]='Si';//dato que va a mostrar al usuario ejem: Elemento 1, Elemento 2, etc. otro: Administrador, Vendedor, Contador, Invitado, etc. 
$opt_name[$p][1]='No';//Además puedes tener del campo de la tabla en caso de selectBD

$opt_value[$p][0]='1';//value del option, campo de la tabla externa de la consulta del combo
$opt_value[$p][1]='0';

$opt_sel[$p][0]='selected';//selected del option, campo de la tabla externa de la consulta del combo, en caso que sea de forma estática se pone en uno solo "selected"
$opt_sel[$p][1]='';// cuando sea selecBD en la primera fila se pone el alias del id de la tabla externa asociada al selecBD
// valores que va a tomar el campo tipo <select> en cada <option>
...
$n_label_ayuda[0]=array('texto'=>$columna[2],'exp'=>'Per&iacute;odo evaluativo');
$n_label_ayuda[1]=array('texto'=>$columna[4],'exp'=>'Asignatura');
$n_label_ayuda[2]=array('texto'=>$columna[5],'exp'=>'Examen evaluativo');
$n_label_ayuda[3]=array('texto'=>$columna[6],'exp'=>'Abreviatura');
$n_label_ayuda[4]=array('texto'=>$columna[7],'exp'=>'Peso');
$n_label_ayuda[5]=array('texto'=>$columna[8],'exp'=>'Visualizan los padres de familia? Si o No (Se utiliza para la visualizaci&oacuten de deberes');
$n_label_ayuda[6]=array('texto'=>$columna[9],'exp'=>'Orden del tipo de actividad o examen dentro de los cuadernos de clase');
...
$m_label_ayuda[0]=array('texto'=>$columna[2],'exp'=>'Per&iacute;odo evaluativo');
$m_label_ayuda[1]=array('texto'=>$columna[4],'exp'=>'Asignatura');
$m_label_ayuda[2]=array('texto'=>$columna[5],'exp'=>'Examen evaluativo');
$m_label_ayuda[3]=array('texto'=>$columna[6],'exp'=>'Abreviatura');
$m_label_ayuda[4]=array('texto'=>$columna[7],'exp'=>'Peso');
$m_label_ayuda[5]=array('texto'=>$columna[8],'exp'=>'Visualizan los padres de familia? Si o No (Se utiliza para la visualizaci&oacuten de deberes');
$m_label_ayuda[6]=array('texto'=>$columna[9],'exp'=>'Orden del tipo de actividad o examen dentro de los cuadernos de clase');
