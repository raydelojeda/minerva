...
$tabla_anidada2[4]='familiar';
$tabla_anidada2[5]='persona AS per_fam';
$tabla_anidada2[6]='usuario';
...
$campo_anidado2[4]='id_familiar';
$campo_anidado2[5]='id_persona';
$campo_anidado2[6]='id_persona';
...
AND familiar.id_persona=per_fam.id_persona 
AND per_fam.id_persona=usuario.id_persona
AND usuario='".$_SESSION["user"]."'";
...
$field[5]='persona.direccion';
$field[6]='persona.email';
$field[7]='persona.telefono1';
$field[8]='persona.telefono2';
$field[9]='persona.residencia';
...
$field[24]=$tabla_anidada[0].'.camino_foto';
...
$field_busqueda[5]='persona.direccion';
$field_busqueda[6]='persona.email';
