...
$elemento_titulo="de responsable de acta"; // para el título
$elemento="responsable_acta"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a los responsables de acta registrados en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="n_responsable_acta";// tabla de la BD

$tabla_anidada=array();
//$tabla_anidada[0]='n_responsable_acta';
//$tabla_anidada[1]='';

$campo_anidado=array();
//$campo_anidado[0]='id_responsable_acta';
//$campo_anidado[1]='';

$field[0]='id_responsable_acta'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='nombre';
$field[2]='cargo';

$alias_col=array();
$alias_col[0]='id_responsable_acta';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='nombre';
$alias_col[2]='cargo';

$columna[0]=''; // labels o encabezados, $field[0] es la llave de la tabla por tanto no lleva label (NO TOCAR)
$columna[1]='Nombre de responsable de acta';
$columna[2]='Cargo de responsable de acta';
...
$l_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Nombre de responsable de acta');
$l_label_ayuda[1]=array('texto'=>$columna[1],'exp'=>'Cargo de responsable de acta');
...
$insert_field[0]='id_responsable_acta'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='nombre'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
$insert_field[2]='cargo';
...
$ff=5;
$f=6;
$combo_sql[$f] = "select id_responsable_acta as id_emp, nombre_emp as emp from n_responsable_acta order by fecha_crea";
...
$n_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Nombre de responsable de acta');
$n_label_ayuda[1]=array('texto'=>$columna[1],'exp'=>'Cargo de responsable de acta');
...
$m_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Nombre de responsable de acta');
$m_label_ayuda[1]=array('texto'=>$columna[1],'exp'=>'Cargo de responsable de acta');
