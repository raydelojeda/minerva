...
$elemento_titulo="del grado"; // para el título
$elemento="grado"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a los tipos de sangre registrados en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="n_grado";// tabla de la BD

$tabla_anidada[0]='n_seccion_academica';

$tabla_anidada2[0]='n_grado as gra';

$campo_anidado[0]='id_seccion_academica';

$campo_anidado2[0]='gra.id_proximo_grado';

$where=' AND gra.id_grado=n_grado.id_proximo_grado';

$field[0]=$tabla.'.id_grado'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]=$tabla.'.grado';
$field[2]='gra.id_proximo_grado';
$field[3]='gra.grado';
$field[4]=$tabla.'.ultimo_grado';
$field[5]=$tabla.'.abreviatura';
$field[6]=$tabla.'.promocion';
$field[7]=$tabla.'.id_seccion_academica';
$field[8]="concat(n_seccion_academica.abreviatura,' - ',seccion_academica)";

$field_busqueda=array();
$field_busqueda[0]=$tabla.'.grado';
$field_busqueda[1]='gra.grado';
$field_busqueda[2]=$tabla.'.abreviatura';
$field_busqueda[3]=$tabla.'.promocion';
$field_busqueda[4]="n_seccion_academica.abreviatura";
$field_busqueda[5]='seccion_academica';

$alias_col=array();
$alias_col[0]='id_grado';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='grado';
$alias_col[2]='id_proximo_grado';
$alias_col[3]='grado_prox';
$alias_col[4]='ult';
$alias_col[5]='abreviatura';
$alias_col[6]='promocion';
$alias_col[7]='id_seccion_academica';
$alias_col[8]='seccion_academica';

$columna[0]=''; // labels o encabezados, $field[0] es la llave de la tabla por tanto no lleva label (NO TOCAR)
$columna[1]='Curso del estudiante';
$columna[2]='Curso del estudiante';
$columna[3]='Curso pr&oacute;ximo';
$columna[4]='&Uacute;ltimo grado';
$columna[5]='Abreviatura';
$columna[6]='Nombre en promoci&oacute;n';
$columna[7]='Secci&oacute;n acad&eacute;mica';
$columna[8]='Secci&oacute;n acad&eacute;mica';
...
$var_mod='';
$columna_suma[0]='';
$href_m='mod_grado.php?mod='; // camino de la pagina para Editar
...
$l_label_ayuda[0]=array('texto'=>$columna[2],'exp'=>'Grado del estudiante');
$l_label_ayuda[1]=array('texto'=>$columna[3],'exp'=>'Grado pr&oacute;ximo al que debe pasar el estudiante');
$l_label_ayuda[2]=array('texto'=>$columna[4],'exp'=>'Es el &uacute;ltimo grado?: Si o No');
...
$l_label_ayuda[5]=array('texto'=>$columna[8],'exp'=>'Abreviatura y secci&oacute;n acad&eacute;mica a la que pertenece el curso');
...
$l_botones[1]=array('target'=>'_self','href'=>'#','onclic'=>'modif(\'mod_grado.php\')','src'=>$x.'img/general/Editar.png','nombre'=>'editar','texto'=>'Editar','accion'=>'Editar');
...
$insert_field[0]='id_grado'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='grado'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
$insert_field[2]='id_proximo_grado';
$insert_field[3]='';
$insert_field[4]='ultimo_grado';
$insert_field[5]='abreviatura';
$insert_field[6]='promocion';
$insert_field[7]='id_seccion_academica';
$insert_field[8]='';
...
$combo_sql[$f] = "select id_grado as id_grado, grado as gra from n_grado order by grado";

$opt_name=array();
$opt_name[$f][0]='gra';//dato que va a mostrar al usuario ejem: Elemento 1, Elemento 2, etc. otro: Administrador, Vendedor, Contador, Invitado, etc. 
...
$opt_sel=array();
$opt_sel[$f][0]='id_grado';//selected del option, campo de la tabla externa de la consulta del combo, en caso que sea de forma estática se pone en uno solo "selected"
...
$combo_sql[$g] = "select id_seccion_academica as id_seccion_academica, concat(abreviatura,' - ',seccion_academica) as seccion_academica from n_seccion_academica order by orden ASC";

$opt_name[$g][0]='seccion_academica';//dato que va a mostrar al usuario ejem: Elemento 1, Elemento 2, etc. otro: Administrador, Vendedor, Contador, Invitado, etc. 
$opt_name[$g][1]='';//Además puedes tener del campo de la tabla en caso de selectBD

$opt_value[$g][0]='id_seccion_academica';//value del option, campo de la tabla externa de la consulta del combo
$opt_value[$g][1]='';

$opt_sel[$g][0]='id_seccion_academica';//selected del option, campo de la tabla externa de la consulta del combo, en caso que sea de forma estática se pone en uno solo "selected"
...
$n_label_ayuda[0]=array('texto'=>$columna[2],'exp'=>'Grado del estudiante');
$n_label_ayuda[1]=array('texto'=>$columna[3],'exp'=>'Grado pr&oacute;ximo al que debe pasar el estudiante');
$n_label_ayuda[2]=array('texto'=>$columna[4],'exp'=>'Es el &uacute;ltimo grado?: Si o No');
...
$n_label_ayuda[5]=array('texto'=>$columna[8],'exp'=>'Abreviatura y secci&oacute;n acad&eacute;mica a la que pertenece el curso');
...
$m_label_ayuda[0]=array('texto'=>$columna[2],'exp'=>'Grado del estudiante');
$m_label_ayuda[1]=array('texto'=>$columna[3],'exp'=>'Grado pr&oacute;ximo al que debe pasar el estudiante');
$m_label_ayuda[2]=array('texto'=>$columna[4],'exp'=>'Es el &uacute;ltimo grado?: Si o No');
...
$m_label_ayuda[5]=array('texto'=>$columna[8],'exp'=>'Abreviatura y secci&oacute;n acad&eacute;mica a la que pertenece el curso');
