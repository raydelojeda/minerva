...
$elemento_titulo="de examen adicional"; // para el título
$elemento="examen_adicional"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a los ex&aacute;menes adicionales registrados en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="n_examen_adicional";// tabla de la BD

$tabla_anidada=array();
//$tabla_anidada[0]='n_examen_adicional';
//$tabla_anidada[1]='';

$campo_anidado=array();
//$campo_anidado[0]='id_examen_adicional';
//$campo_anidado[1]='';

$field[0]='id_examen_adicional'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='examen_adicional';
$field[2]='abv_examen';

$alias_col=array();
$alias_col[0]='id_examen_adicional';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='examen_adicional';
$alias_col[2]='abv_examen';
...
$columna[2]='Abreviatura del examen';
...
$l_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Nombre del examen adicional');
$l_label_ayuda[1]=array('texto'=>$columna[1],'exp'=>'Abreviatura del examen adicional');
...
$insert_field[0]='id_examen_adicional'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='examen_adicional'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
$insert_field[2]='abv_examen';
...
$ff=5;
$f=6;
$combo_sql[$f] = "select id_examen_adicional as id_emp, nombre_emp as emp from n_examen_adicional order by fecha_crea";
...
$n_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Nombre del examen adicional');
$n_label_ayuda[1]=array('texto'=>$columna[1],'exp'=>'Abreviatura del examen adicional');
...
$m_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Nombre del examen adicional');
$m_label_ayuda[1]=array('texto'=>$columna[1],'exp'=>'Abreviatura del examen adicional');
