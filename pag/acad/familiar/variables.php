...
$elemento_titulo="de familiares con estudiantes admitidos o matriculados en el per&iacute;odo actual"; // para el título
$elemento="familiar"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a los familiares registrados en la base de datos.";//introduccion de la ayuda
...
$tabla_anidada2[4]='n_periodo_academico';
$tabla_anidada2[5]='estudiante';
$tabla_anidada2[6]='curso_grado_paralelo_est';
$tabla_anidada2[7]='grado_paralelo_periodo';
...
$campo_anidado2[4]='id_periodo_academico';
$campo_anidado2[5]='id_estudiante';
$campo_anidado2[6]='id_curso_grado_paralelo_est';
$campo_anidado2[7]='id_grado_paralelo_periodo';
...
AND n_tipo_identificacion.id_tipo_identificacion=persona.id_tipo_identificacion AND n_periodo_academico.id_periodo_academico=grado_paralelo_periodo.id_periodo_academico 
AND grado_paralelo_periodo.id_grado_paralelo_periodo=curso_grado_paralelo_est.id_grado_paralelo_periodo AND estudiante.id_estudiante=curso_grado_paralelo_est.id_estudiante
AND estudiante.id_estudiante=familiar_estudiante.id_estudiante AND n_periodo_academico.activo=1';

//$order=" per DESC";

$field=array();
$field[0]='DISTINCT '.$tabla.'.id_familiar'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
...
$var_mod='';
$columna_suma[0]='';
$href_m='mod_familiar.php?mod='; // camino de la pagina para Editar
