...
{	
	...
	$sql_obs="SELECT nota_comportamental_sub_tut.id_nota_comportamental_sub_tut FROM nota_comportamental_sub_tut 
	...
	{
?>
		<input type="hidden" name="hdn_id_nota_comportamental_sub_tut_<?php print $id_gra_par;?>" value="<?php print $rs_obs->fields['id_nota_comportamental_sub_tut'];?>">
		...
		<input type="hidden" name="hdn_id_obs_comportamental_sub_tut_<?php print $id_gra_par;?>" value="">
		...
		<fieldset>
			...
			<br>
			<fieldset>
				<legend>Insertar observaci&oacute;n de comportamiento del tutor</legend>
						...
						<tr>
							<td class="botonera_encabezado">
								<div style='text-align:center;'>
									...
									{callbackPaso1;}
									haceAlgo(ejecutar_ajax('comportamiento/actualizar_grid.php','hdn_id_grado_<?php print $id_grado;?>, hdn_id_paralelo_<?php print $id_paralelo;?>', 'contenido_grid_comportamiento_<?php print $id_gra_par;?>', ejecutar_ajax1('comportamiento/ins_obs_comportamiento.php','hdn_id_nota_comportamental_sub_tut_<?php print $id_gra_par;?>, txt_fecha_comp_<?php print $id_gra_par;?>, rbt_positiva_<?php print $id_gra_par;?>, rbt_destacada_<?php print $id_gra_par;?>, txt_nota_<?php print $id_gra_par;?>, txt_obs_<?php print $id_gra_par;?>, hdn_id_curso_grado_paralelo_est_<?php print $id_gra_par;?>, hdn_id_subperiodo_evaluativo_<?php print $id_gra_par;?>, hdn_modificar_<?php print $id_gra_par;?>, hdn_id_obs_comportamental_sub_tut_<?php print $id_gra_par;?>, hdn_id_gra_<?php print $id_grado;?>, hdn_id_par_<?php print $id_gra_par;?>','div_listado_obs_<?php print $id_gra_par;?>')));limpiar_campos(String('txt_obs_<?php print $id_gra_par;?>').split(','));document.frm.hdn_modificar_<?php print $id_gra_par;?> .value=0; " target="_self">
			...
			<fieldset>
				...
				<div id='div_listado_obs_<?php print $id_gra_par;?>'>					
					<?php $tutoria->mostrar_obs_comportamiento($db, $id_curso_grado_paralelo_est, $id_subperiodo_evaluativo, $id_grado, $id_paralelo, '../../../', '1');?>
				</div>
