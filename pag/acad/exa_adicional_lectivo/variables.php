...
$elemento_titulo="de examen adicional del per&iacute;odo lectivo (Anual)"; // para el título
$elemento="exa_adicional_lectivo"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto al examen adicional del per&ioacute;odo lectivo, registrados en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="n_exa_adicional_lectivo";// tabla de la BD

$tabla_anidada=array();
$tabla_anidada[0]='n_examen_periodo_lec';
$tabla_anidada[1]='n_examen_adicional';
$tabla_anidada[2]='n_tipo_examen';

$campo_anidado=array();
$campo_anidado[0]='id_examen_periodo_lec';
...
$where=' AND n_asignatura.id_asignatura=n_examen_periodo_lec.id_asignatura AND n_periodo_lectivo.id_periodo_lectivo=n_examen_periodo_lec.id_periodo_lectivo AND n_periodo_lectivo.id_conf_academica=n_conf_academica.id_conf_academica AND n_conf_academica.activa="1"';

$field[0]=$tabla.'.id_exa_adicional_lectivo'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]=$tabla.'.id_examen_adicional';
$field[2]="concat(abv_examen,' - ',examen_adicional)";
$field[3]=$tabla.'.id_tipo_examen';
$field[4]="tipo_examen";
$field[5]=$tabla.'.id_examen_periodo_lec';
$field[6]="concat(examen_lec,' - ',asignatura)";
$field[7]='publica_nota';
$field[8]='sustituye_nota';
$field[9]='orden';

$alias_col=array();
$alias_col[0]='ID_exa_adicional_lectivo';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='id_examen_adicional';
$alias_col[2]='examen_adicional';
$alias_col[3]='id_tipo_examen';
$alias_col[4]='tipo_examen';
$alias_col[5]='id_examen_periodo_lec';
$alias_col[6]='examen_lec_asignatura';
...
$columna[5]='Examen lectivo y asignatura';
$columna[6]='Examen lectivo y asignatura';
...
$l_label_ayuda[2]=array('texto'=>$columna[6],'exp'=>'Examen lectivo y asignatura al que pertenece el examen adicional');
...
$l_botones[0]=array('target'=>'_self','href'=>'new_exa_adicional_lectivo2.php','onclic'=>'','src'=>$x.'img/general/nuevo.png','nombre'=>'nuevo','texto'=>'Gestionar','accion'=>'Insertar');
...
$insert_field[0]='id_exa_adicional_lectivo'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
...
$insert_field[4]='';
$insert_field[5]='id_examen_periodo_lec';
$insert_field[6]='';
...
$label_input[8]='Sustituye la nota del per&iacute;odo lectivo?';
...
$combo_sql[$r] = "SELECT id_examen_periodo_lec as id_examen_periodo_lec, concat(examen_lec,' - ',asignatura) as examen_lec_asignatura
FROM n_asignatura, n_examen_periodo_lec, n_periodo_lectivo, n_conf_academica WHERE 1 AND n_examen_periodo_lec.id_asignatura=n_asignatura.id_asignatura AND n_examen_periodo_lec.id_periodo_lectivo=n_periodo_lectivo.id_periodo_lectivo AND n_periodo_lectivo.id_conf_academica=n_conf_academica.id_conf_academica AND n_conf_academica.activa='1'";

$opt_name[$r][0]='examen_lec_asignatura';//dato que va a mostrar al usuario ejem: Elemento 1, Elemento 2, etc. otro: Administrador, Vendedor, Contador, Invitado, etc. //Además puedes tener del campo de la tabla en caso de selectBD
$opt_value[$r][0]='id_examen_periodo_lec';//value del option, campo de la tabla externa de la consulta del combo
$opt_sel[$r][0]='id_examen_periodo_lec';//selected del option, campo de la tabla externa de la consulta del combo, en caso que sea de forma estática se pone en uno solo "selected"// cuando sea selecBD en la primera fila se pone el alias del id de la tabla externa asociada al selecBD
...
$texto_input[8]='Si es "Si" ser&iacute;a la nota del per&iacute;odo. Si es "No" se calcular&iacute;a la nota del per&iacute;odo lectivo seg&uacute;n los pesos.';
...
$n_label_ayuda[2]=array('texto'=>$columna[6],'exp'=>'Examen lectivo y asignatura al que pertenece el examen adicional');
...
$m_label_ayuda[2]=array('texto'=>$columna[6],'exp'=>'Examen lectivo y asignatura al que pertenece el examen adicional');
