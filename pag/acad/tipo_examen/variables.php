...
$elemento_titulo="de tipo de examen"; // para el título
$elemento="tipo_examen"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a los tipos de ex&aacute;menes registrados en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="n_tipo_examen";// tabla de la BD

$tabla_anidada=array();
//$tabla_anidada[0]='n_tipo_examen';
//$tabla_anidada[1]='';

$campo_anidado=array();
//$campo_anidado[0]='id_tipo_examen';
//$campo_anidado[1]='';

$field[0]='id_tipo_examen'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='tipo_examen';
$field[2]='opcional';

$alias_col=array();
$alias_col[0]='id_tipo_examen';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='tipo_examen';
$alias_col[2]='opcional';

$columna[0]=''; // labels o encabezados, $field[0] es la llave de la tabla por tanto no lleva label (NO TOCAR)
$columna[1]='Tipo de examen';
$columna[2]='Opcional';
...
$l_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Tipo de examen (suplencia, recuperaci&oacute;n, etc.)');
$l_label_ayuda[1]=array('texto'=>$columna[1],'exp'=>'Opcional: Si o No');
...
$insert_field[0]='id_tipo_examen'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='tipo_examen'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
$insert_field[2]='opcional';
...
$n_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Tipo de examen (suplencia, recuperaci&oacute;n, etc.)');
$n_label_ayuda[1]=array('texto'=>$columna[1],'exp'=>'Opcional: Si o No');
...
$m_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Tipo de examen (suplencia, recuperaci&oacute;n, etc.)');
$m_label_ayuda[1]=array('texto'=>$columna[1],'exp'=>'Opcional: Si o No');
