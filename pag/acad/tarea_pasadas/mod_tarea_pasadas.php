...
<div>
	...
	<div id='modal_modificar_actividad'>
					...
					<legend><?php print $s_rs->fields['act_mod'];?></legend>
						<div class="tab-pane" id="tabPane1" style='align:center;'>
							...
							<div class="tab-page">
								...
								<?php
									include($x."pag/acad/tarea_pasadas/variables.php");
									
									$sql_t = "SELECT id_tarea as id_tarea, fecha_ini as inic, fecha_fin as fin, opcional as opc, descripcion FROM tarea WHERE id_tarea='".$mod."'";
							...
							<div class="tab-page">
								...
								<textarea name="txt_descrip_mod" disabled style="background-color:#ddd" title="Descripci&oacute;n" id="txt_descrip_mod" cols="80"><?php print $rs_t->fields['descripcion'];?></textarea>
								<script>
									CKEDITOR.replace('txt_descrip_mod');
								</script>
							</div>
		...
		?>
		<textarea name="hdn_txt_descrip_mod" id="hdn_txt_descrip_mod" rows="5" cols="80" style="display:none;"></textarea>
	</div>
</div>
