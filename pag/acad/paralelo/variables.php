...
$elemento_titulo="del paralelo"; // para el título
$elemento="paralelo"; // elemento o nomenclador al que se accede
...
$tabla="n_paralelo";// tabla de la BD

$tabla_anidada=array();
//$tabla_anidada[0]='n_paralelo';
//$tabla_anidada[1]='';

$campo_anidado=array();
//$campo_anidado[0]='id_paralelo';
//$campo_anidado[1]='';

$field[0]='id_paralelo'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='paralelo';

$alias_col=array();
$alias_col[0]='id_paralelo';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='gra';

$columna[0]=''; // labels o encabezados, $field[0] es la llave de la tabla por tanto no lleva label (NO TOCAR)
$columna[1]='Paralelo del estudiante';
...
$var_mod='';
$columna_suma[0]='';
$href_m='mod_paralelo.php?mod='; // camino de la pagina para Editar
...
$l_botones[1]=array('target'=>'_self','href'=>'#','onclic'=>'modif(\'mod_paralelo.php\')','src'=>$x.'img/general/Editar.png','nombre'=>'editar','texto'=>'Editar','accion'=>'Editar');
...
$insert_field[0]='id_paralelo'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='paralelo'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
...
$ff=5;
$f=6;
$combo_sql[$f] = "select id_paralelo as id_emp, nombre_emp as emp from n_paralelo order by fecha_crea";
