...
$elemento_titulo="de tiempo de antelaci&oacute;n para deberes en casa"; // para el título
$elemento="hora_antelacion"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto al tiempo de antelaci&oacute;n para deberes en casa registrado en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="n_hora_antelacion";// tabla de la BD

$tabla_anidada=array();
//$tabla_anidada[0]='n_hora_antelacion';
//$tabla_anidada[1]='';

$campo_anidado=array();
//$campo_anidado[0]='id_hora_antelacion';
//$campo_anidado[1]='';

$field[0]='id_hora_antelacion'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='hora_antelacion';
$field[2]='dias_antelacion';

$alias_col=array();
$alias_col[0]='id_hora_antelacion';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='hora_antelacion';
$alias_col[2]='dias_antelacion';

$columna[0]=''; // labels o encabezados, $field[0] es la llave de la tabla por tanto no lleva label (NO TOCAR)
$columna[1]='Horas de antelaci&oacute;n';
$columna[2]='D&iacute;as de antelaci&oacute;n';
...
$l_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Horas de antelaci&oacute;n para poner un deber a los estudiantes');
$l_label_ayuda[1]=array('texto'=>$columna[1],'exp'=>'D&iacute;as de antelaci&oacute;n para poner un deber a los estudiantes');
...
$insert_field[0]='id_hora_antelacion'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='hora_antelacion'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
$insert_field[2]='dias_antelacion';
...
$ff=5;
$f=6;
$combo_sql[$f] = "select id_hora_antelacion as id_emp, nombre_emp as emp from n_hora_antelacion order by fecha_crea";
...
$n_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Horas de antelaci&oacute;n para poner un deber a los estudiantes');
$n_label_ayuda[1]=array('texto'=>$columna[1],'exp'=>'D&iacute;as de antelaci&oacute;n para poner un deber a los estudiantes');
...
$m_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Horas de antelaci&oacute;n para poner un deber a los estudiantes');
$m_label_ayuda[1]=array('texto'=>$columna[1],'exp'=>'D&iacute;as de antelaci&oacute;n para poner un deber a los estudiantes');
