...
$sql_p="SELECT id_persona FROM estudiante WHERE id_estudiante='".$id_estudiante."'";
...
$sql_c="SELECT id_curso_grado_paralelo_est FROM curso_grado_paralelo_est, grado_paralelo_periodo, n_periodo_academico
...
AND activo='1'
AND id_estudiante='".$id_estudiante."' ";//print $sql_c;
...
if(isset($_POST['aux_submit']))
{
	if($_POST['aux_submit']=='ok')
	{
		...
		include("variables.php");
		$mensaje=$obj->Consulta_update($field_unico,$tabla,$field,$insert_field,$insert_alias,$name_input,$label_input,$db,$id_estudiante,$tipo_input,$value_input,$x);
...
function valida_parentesco() 
{
	...
	validar_form('ide','','Rvarchar','prin','','Rvarchar','segn','','varchar','pria','','Rvarchar','sega','','varchar','fec','','Rfecha','dir','','varchar','ema','','email','tel1','','varchar','tel2','','varchar','res','','Rselec','pais','','Rselec','gen','','Rselec','tip','','Rselec','tide','','Rselec','c_f','','varchar','nombre_dir','','Rvarchar','calle_ppal','','Rvarchar','numero','','Rvarchar','luga','','Rinput','grado_paralelo','','Rselec','fecha_admision','','Rfecha','fecha_matricula','','fecha','codigo_matricula','','input'); 
	else
	validar_form('ide','','Rvarchar','prin','','Rvarchar','segn','','varchar','pria','','Rvarchar','sega','','varchar','fec','','Rfecha','dir','','varchar','ema','','email','tel1','','varchar','tel2','','varchar','res','','Rselec','pais','','Rselec','gen','','Rselec','tip','','Rselec','tide','','Rselec','c_f','','varchar','nombre_dir','','Rvarchar','calle_ppal','','Rvarchar','numero','','Rvarchar','luga','','Rinput','grado_paralelo','','Rselec','fecha_admision','','Rfecha','fecha_matricula','','fecha','codigo_matricula','','input','fecha_retiro','','Rfecha','cumplido','','Rselec'); 
}
		...
		<div class="tab-page">
			...
			<div style='display:table;width:100%;'>			
				<div style='display:table-row;'>
					...
					<div style='display:table-cell;height:22px;text-align:left;'>
						<select <?php print $disable;?> class="js-basic-single_paralelo" name="sel_paralelo" id="sel_paralelo">
							<option value='0'>----------------------Seleccionar----------------------</option>
							<?php $rs_p->MoveFirst();for($e=0;$e<$rs_p->RecordCount();$e++){?>					
				...
				<div style='display:table-row;'>
					...
					<div style='display:table-cell;height:22px;text-align:left;'>
						<input <?php print $disable;?> id="fecha_admision" type="text" value="<?php print $s_rs3->fields['fecha_admision'];?>" maxlength="10" size="10" onclick='displayCalendar(document.frm.fecha_admision,"yyyy-mm-dd",this);' title="Fecha de admisi&oacute;n" name="fecha_admision" placeholder="">*
					</div>
				</div>
				...
				<div style='display:table-row;'>
					...
					<div style='display:table-cell;height:22px;text-align:left;'>
						<input <?php print $disable;?> id="fecha_matricula" type="text" value="<?php if($s_rs3->fields['fecha_matricula']!='0000-00-00')print $s_rs3->fields['fecha_matricula'];?>" maxlength="10" size="10" onclick='displayCalendar(document.frm.fecha_matricula,"yyyy-mm-dd",this);' title="Fecha de matr&iacute;cula" name="fecha_matricula" placeholder="">*
					</div>
				</div>
				...
				<div style='display:table-row;'>
					...
					<div style='display:table-cell;height:22px;text-align:left;'>
						<input <?php print $disable;?> id="codigo_matricula" type="text" value="<?php print $s_rs3->fields['codigo_matricula'];?>" maxlength="10" size="10" title="C&oacute;digo de matr&iacute;cula" name="codigo_matricula" placeholder="">*
					</div>
				</div>
				...
				<br>
					<div id='retirado' <?php if(isset($s_rs3->fields['retirado']) AND $s_rs3->fields['retirado']==0){?>style='display:none;'<?php }else{?>style='display:table-row;'<?php }?>>
						...
						<div style='display:table-cell;height:22px;text-align:left;'>
							<input <?php print $disable;?> id="fecha_retiro" type="text" value="<?php if($s_rs3->fields['fecha_retiro']!='0000-00-00')print $s_rs3->fields['fecha_retiro'];?>" onclick='displayCalendar(document.frm.fecha_retiro,"yyyy-mm-dd",this);' maxlength="10" size="10" title="Fecha de retiro" name="fecha_retiro" placeholder="">
						</div>
					</div>
					...
					<div id='retirado1' <?php if(isset($s_rs3->fields['retirado']) AND $s_rs3->fields['retirado']==0){?>style='display:none;'<?php }else{?>style='display:table-row;'<?php }?>>
						...
						<div style='display:table-cell;height:22px;text-align:left;'>
							<section style='width:25px;text-align:left;'>
								<div class="checkbox-3" style='text-align:left;'>
									<input <?php print $disable;?> class="checkbox_oculto" name='cbx_cumplido' value='1' <?php if(isset($s_rs3->fields['cumplido']) AND $s_rs3->fields['cumplido']==1)print 'checked';?> type="checkbox" id="cbx_cumplido" />
