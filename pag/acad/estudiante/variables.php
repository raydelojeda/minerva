...
AND n_periodo_academico.id_periodo_academico=grado_paralelo_periodo.id_periodo_academico AND n_periodo_academico.activo=1';
...
$field_busqueda[6]='fecha_admision';
$field_busqueda[7]="fecha_matricula";
$field_busqueda[8]='fecha_retiro';
$field_busqueda[9]=$tabla_anidada2[4].'.abreviatura';
$field_busqueda[10]="grado";
...
$l_botones[1]=array('target'=>'','href'=>'#','onclic'=>'seleccion(\'planilla_matricula.php\')','src'=>$x.'img/general/doc.png','nombre'=>'planilla','texto'=>'Acta','accion'=>'Imprimir');
...
$l_botones[4]=array('target'=>'_self','href'=>'#','onclic'=>'seleccion(\'eliminar.php\')','src'=>$x.'img/general/eliminar.png','nombre'=>'eliminar','texto'=>'Desadmitir','accion'=>'Eliminar');
