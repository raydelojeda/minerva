...
//------------------------------------------------INSERTAR------------------------------------------------
$insert_field=array();
$insert_field[0]='id_enfermedad_est'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='id_datos_clinicos'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
$insert_field[2]='';
$insert_field[3]='id_enfermedad';
$insert_field[4]='';
$insert_field[5]='tuvo';
$insert_field[6]='tiene';
$insert_field[7]='descripcion';

$insert_alias=array();
$insert_alias[0]='id_enfermedad_est'; //alias de los campos de la consulta, debe haber alias en todos los campos
$insert_alias[1]='id_datos_clinicos';
$insert_alias[2]='datos';
$insert_alias[3]='id_enfermedad';
$insert_alias[4]='enfermedad';
$insert_alias[5]='tuvo';
$insert_alias[6]='tiene';
$insert_alias[7]='descripcion_enfer';
...
$label_input[2]='';
$label_input[3]='Enfermedad';
$label_input[4]='Enfermedad';
$label_input[5]='Tuvo';
$label_input[6]='Tiene';
$label_input[7]='Descripci&oacute;n';
...
$combo_sql[$f] = "select id_enfermedad as id_enfermedad, enfermedad as enfermedad 
FROM n_enfermedad ORDER BY enfermedad";

$opt_name=array();
$opt_name[$f][0]='enfermedad';//dato que va a mostrar al usuario ejem: Elemento 1, Elemento 2, etc. otro: Administrador, Vendedor, Contador, Invitado, etc. 
$opt_name[$f][1]='';//Además puedes tener del campo de la tabla en caso de selectBD
$opt_name[$f][2]='';
$opt_name[$f][3]='';

$opt_value=array();
$opt_value[$f][0]='id_enfermedad';//value del option, campo de la tabla externa de la consulta del combo
$opt_value[$f][1]='';
$opt_value[$f][2]='';
$opt_value[$f][3]='';

$opt_sel=array();
$opt_sel[$f][0]='id_enfermedad';//selected del option, campo de la tabla externa de la consulta del combo, en caso que sea de forma estática se pone en uno solo "selected"
