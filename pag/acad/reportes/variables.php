...
$elemento_titulo=""; // para el título
$elemento="reportes"; // elemento o nomenclador al que se accede
$camino="pag/acad/".$elemento; // camino para acceder
$location=$x.$camino;

$img_encabezado="img/acad/".$elemento."/".$elemento.".png"; //imagen del encabezado

$titulo_listar="Reportes para descarga en PDF".$elemento_titulo.""; //titulo del encabezado
$titulo_nuevo="Reportes para descarga en PDF".$elemento_titulo.""; //titulo del encabezado
