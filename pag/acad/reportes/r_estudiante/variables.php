...
$elemento_titulo="de estudiante en cualquier per&iacute;odo no activo"; // para el título
$elemento="r_estudiante"; // elemento o nomenclador al que se accede
$camino="pag/acad/reportes/".$elemento; // camino para acceder
$location=$x.$camino;

$img_encabezado="img/acad/".$elemento."/".$elemento.".png"; //imagen del encabezado

$titulo_listar="Historial ".$elemento_titulo.": listar"; //titulo del encabezado
...
AND n_grado_paralelo.id_paralelo=n_paralelo.id_paralelo AND n_grado_paralelo.id_grado_paralelo=grado_paralelo_periodo.id_grado_paralelo AND n_periodo_academico.id_periodo_academico=grado_paralelo_periodo.id_periodo_academico AND n_periodo_academico.activo='0'";
...
$field_busqueda[5]='fecha_nacimiento';
$field_busqueda[6]='email';
$field_busqueda[7]="genero";
$field_busqueda[8]="direccion";
$field_busqueda[9]='telefono1';
$field_busqueda[10]='nombre';
$field_busqueda[11]="codigo_matricula";
