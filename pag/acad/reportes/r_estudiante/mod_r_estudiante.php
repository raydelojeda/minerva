...
$s_rs3=$obj->Consulta_llenar_cajas($id_curso_grado_paralelo_est,$insert_field,$tabla,$db,$columna,$insert_alias);
//--------------LLENAR CAJAS PARA CURSO, GRADO, PARALELO Y ESTUDIANTE--------------
