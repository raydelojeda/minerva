...
?>
		...
		<fieldset>
			<legend>Comportamental del <b>tutor</b> para el <b><?php print $rs_est->fields['estudiante'].'</b> en el <b>'.$rs_sub->fields['subperiodo_evaluativo'].' ('.$rs_sub->fields['abv_subperiodo'].')';?></b></legend>

			<fieldset>
				<legend>Listado de observaciones de comportamiento</legend>		
				<div id='div_listado_obs'>					
					<?php $tutoria->mostrar_obs_comportamiento($db, $id_curso_grado_paralelo_est, $id_subperiodo_evaluativo, '1', '1', '../../../../', '0');?>
				</div>
