...
class TCPDF {
	 ...
	 * The definition file (and the font file itself when embedding) must be present either in the current directory or in the one indicated by K_PATH_FONTS if the constant is defined. If it could not be found, the error "Could not include_once font definition file" is generated.
	...
	public function AddFont($family, $style='', $fontfile='', $subset='default') {
		...
		$missing_style = false;
		// search and include_once font file
		...
		// include_once font file
		if (!TCPDF_STATIC::empty_string($fontfile) AND (@file_exists($fontfile))) {
			include($fontfile);
		} else {
			$this->Error('Could not include_once font definition file: '.$family.'');
		}
	 ...
	 * Note: for the standard fonts, the font metric files must be accessible. There are three possibilities for this:<ul><li>They are in the current directory (the one where the running script lies)</li><li>They are in one of the directories defined by the include_once_path parameter</li><li>They are in the directory defined by the K_PATH_FONTS constant</li></ul><br />
	...
	/**
	 * Set page boxes to be include_onced on page descriptions.
	...
	protected function _putinfo() {
		...
		// A name object indicating whether the document has been modified to include_once trapping information
		$out .= ' /Trapped /False';
		$out .= ' >>';
		$out .= "\n".'endobj';
		$this->_out($out);
	 ...
	 * @param $extracerts (string) specifies the name of a file containing a bunch of extra certificates to include_once in the signature which can for example be used to help the recipient to verify the certificate that you used.
