...
class TCPDF_FONTS {
	 ...
	 * @param $addcbbox (boolean) If true include_onces the character bounding box information on the php font file.
	...
	public static function _getTrueTypeFontSubset($font, $subsetchars) {
		...
		// include_once all parts of composite glyphs
...
// ====================================================================================================================
	...
	public static function utf8Bidi($ta, $str='', $forcertl=false, $isunicode=true, &$currentfont) {
		...
		// X8. All explicit directional embeddings and overrides are completely terminated at the end of each paragraph. Paragraph separators are not include_onced in the embedding.
