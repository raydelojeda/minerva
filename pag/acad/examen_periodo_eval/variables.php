...
$elemento_titulo="de examen o actividad del per&iacute;odo evaluativo (Quimestre)"; // para el título
$elemento="examen_periodo_eval"; // elemento o nomenclador al que se accede
...
$tabla="n_examen_periodo_eval";// tabla de la BD

$tabla_anidada=array();
$tabla_anidada[0]='n_periodo_evaluativo';
$tabla_anidada[1]='n_asignatura';

$campo_anidado=array();
$campo_anidado[0]='id_periodo_evaluativo';
...
$where=' AND n_periodo_lectivo.id_periodo_lectivo=n_periodo_evaluativo.id_periodo_lectivo AND n_periodo_lectivo.id_conf_academica=n_conf_academica.id_conf_academica AND n_conf_academica.activa="1"';

$field[0]=$tabla.'.id_examen_periodo_eval'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]=$tabla.'.id_periodo_evaluativo';
$field[2]="periodo_evaluativo";
$field[3]=$tabla.'.id_asignatura';
$field[4]="concat(abreviatura,' - ',asignatura)";
$field[5]='examen_eval';
$field[6]='abv_tipo_examen_eval';
$field[7]='peso';

$alias_col=array();
$alias_col[0]='ID_examen_periodo_eval';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='id_periodo_evaluativo';
$alias_col[2]='id_periodo_evaluativo';
$alias_col[3]='id_asignatura';
$alias_col[4]='id_asignatura';
$alias_col[5]='examen_eval';
$alias_col[6]='abv_tipo_examen_eval';
$alias_col[7]='peso';
...
$l_botones[0]=array('target'=>'_self','href'=>'new_examen_periodo_eval2.php','onclic'=>'','src'=>$x.'img/general/nuevo.png','nombre'=>'nuevo','texto'=>'Gestionar','accion'=>'Insertar');
...
$insert_field[0]='id_examen_periodo_eval'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='id_periodo_evaluativo'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
$insert_field[2]='';
$insert_field[3]='id_asignatura';
$insert_field[4]='';
$insert_field[5]='examen_eval';
$insert_field[6]='abv_tipo_examen_eval';
$insert_field[7]='peso';
...
$combo_sql[$e] = "SELECT n_periodo_evaluativo.id_periodo_evaluativo as id_periodo_evaluativo, periodo_evaluativo as periodo_evaluativo 
FROM n_periodo_evaluativo, n_periodo_lectivo, n_conf_academica WHERE 1 AND n_periodo_lectivo.id_periodo_lectivo=n_periodo_evaluativo.id_periodo_lectivo AND n_periodo_lectivo.id_conf_academica=n_conf_academica.id_conf_academica AND n_conf_academica.activa='1'";

$opt_name[$e][0]='periodo_evaluativo';//dato que va a mostrar al usuario ejem: Elemento 1, Elemento 2, etc. otro: Administrador, Vendedor, Contador, Invitado, etc. //Además puedes tener del campo de la tabla en caso de selectBD
$opt_value[$e][0]='id_periodo_evaluativo';//value del option, campo de la tabla externa de la consulta del combo
$opt_sel[$e][0]='id_periodo_evaluativo';//selected del option, campo de la tabla externa de la consulta del combo, en caso que sea de forma estática se pone en uno solo "selected"// cuando sea selecBD en la primera fila se pone el alias del id de la tabla externa asociada al selecBD
