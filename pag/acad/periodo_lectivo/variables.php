...
$elemento_titulo="de per&iacute;odo lectivo vigente"; // para el título
$elemento="periodo_lectivo"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto al per&iacute;odo lectivo vigente registrado en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
$tabla="n_periodo_lectivo";// tabla de la BD
...
$where=' AND n_conf_academica.activa="1"';

$field[0]='id_periodo_lectivo'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]=$tabla_anidada[0].'.id_conf_academica';
$field[2]="concat(abv_conf_academica,' - ',conf_academica)";
$field[3]='periodo_lectivo';

$alias_col=array();
$alias_col[0]='id_periodo_lectivo';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='id_c';
$alias_col[2]='conf';
$alias_col[3]='periodo_lectivo';
...
$columna[2]='Configuraci&oacute;n acad&eacute;mica';
$columna[3]='Per&iacute;odo lectivo';
...
$var_mod='';
$columna_suma[0]='';
$href_m='mod_periodo_lectivo.php?mod='; // camino de la pagina para Editar
...
$l_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Configuraci&oacute;n acad&eacute;mica a la que pertenece el per&iacute;odo lectivo');
$l_label_ayuda[1]=array('texto'=>$columna[3],'exp'=>'Per&iacute;odo lectivo (Anual)');
...
$l_botones[1]=array('target'=>'_self','href'=>'#','onclic'=>'modif(\'mod_periodo_lectivo.php\')','src'=>$x.'img/general/Editar.png','nombre'=>'editar','texto'=>'Editar','accion'=>'Editar');
...
$insert_field[0]='id_periodo_lectivo'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='id_conf_academica'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
$insert_field[2]='';
$insert_field[3]='periodo_lectivo';
...
$f=2;
$combo_sql[$f] = "select id_conf_academica as id_c, concat(abv_conf_academica,' - ',conf_academica) as conf from n_conf_academica WHERE 1 AND n_conf_academica.activa='1'";

$opt_name=array();
$opt_name[$f][0]='conf';//dato que va a mostrar al usuario ejem: Elemento 1, Elemento 2, etc. otro: Administrador, Vendedor, Contador, Invitado, etc. 
...
$opt_sel=array();
$opt_sel[$f][0]='id_c';//selected del option, campo de la tabla externa de la consulta del combo, en caso que sea de forma estática se pone en uno solo "selected"
...
$n_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Configuraci&oacute;n acad&eacute;mica a la que pertenece el per&iacute;odo lectivo');
$n_label_ayuda[1]=array('texto'=>$columna[3],'exp'=>'Per&iacute;odo lectivo (Anual)');
...
$m_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Configuraci&oacute;n acad&eacute;mica a la que pertenece el per&iacute;odo lectivo');
$m_label_ayuda[1]=array('texto'=>$columna[3],'exp'=>'Per&iacute;odo lectivo (Anual)');
