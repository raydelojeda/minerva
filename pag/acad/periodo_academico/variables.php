...
$elemento_titulo="de per&iacute;odo acad&eacute;mico"; // para el título
$elemento="periodo_academico"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a los per&iacute;odo acad&eacute;mico registrados en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="n_periodo_academico";// tabla de la BD
...
$field[0]='id_periodo_academico'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='fecha_ini';
$field[2]='fecha_fin';
$field[3]='nombre';
$field[4]='activo';
...
$alias_col=array();
$alias_col[0]='id_periodo_academico';//alias de los campos de la consulta, debe haber alias en todos los campos
...
$columna[1]='Fecha incial';
$columna[2]='Fecha final';
$columna[3]='Descripci&oacute;n';
$columna[4]='Activo';
...
$l_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Fecha incial del per&iacute;odo acad&eacute;mico');
$l_label_ayuda[1]=array('texto'=>$columna[2],'exp'=>'Fecha final del per&iacute;odo acad&eacute;mico');
$l_label_ayuda[2]=array('texto'=>$columna[3],'exp'=>'Descripci&oacute;n del per&iacute;odo acad&eacute;mico');
$l_label_ayuda[3]=array('texto'=>$columna[4],'exp'=>'Activo: Si o No');
...
$insert_field[0]='id_periodo_academico'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='fecha_ini'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
$insert_field[2]='fecha_fin';
$insert_field[3]='nombre';
$insert_field[4]='activo';
...
$n_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Fecha incial del per&iacute;odo acad&eacute;mico');
$n_label_ayuda[1]=array('texto'=>$columna[2],'exp'=>'Fecha final del per&iacute;odo acad&eacute;mico');
$n_label_ayuda[2]=array('texto'=>$columna[3],'exp'=>'Descripci&oacute;n del per&iacute;odo acad&eacute;mico');
$n_label_ayuda[3]=array('texto'=>$columna[4],'exp'=>'Activo: Si o No');
...
$m_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Fecha incial del per&iacute;odo acad&eacute;mico');
$m_label_ayuda[1]=array('texto'=>$columna[2],'exp'=>'Fecha final del per&iacute;odo acad&eacute;mico');
$m_label_ayuda[2]=array('texto'=>$columna[3],'exp'=>'Descripci&oacute;n del per&iacute;odo acad&eacute;mico');
$m_label_ayuda[3]=array('texto'=>$columna[4],'exp'=>'Activo: Si o No');
