...
$elemento_titulo="de enfermedad"; // para el título
$elemento="enfermedad"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a las enfermedades registradas en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="n_enfermedad";// tabla de la BD

$tabla_anidada=array();
//$tabla_anidada[0]='n_enfermedad';
//$tabla_anidada[1]='';

$campo_anidado=array();
//$campo_anidado[0]='id_enfermedad';
//$campo_anidado[1]='';

$field[0]='id_enfermedad'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]='enfermedad';

$alias_col=array();
$alias_col[0]='id_enfermedad';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='gra';

$columna[0]=''; // labels o encabezados, $field[0] es la llave de la tabla por tanto no lleva label (NO TOCAR)
$columna[1]='Enfermedad';
...
$var_mod='';
$columna_suma[0]='';
$href_m='mod_enfermedad.php?mod='; // camino de la pagina para Editar
...
$l_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Paralelo del estudiante');
...
$l_botones[1]=array('target'=>'_self','href'=>'#','onclic'=>'modif(\'mod_enfermedad.php\')','src'=>$x.'img/general/Editar.png','nombre'=>'editar','texto'=>'Editar','accion'=>'Editar');
...
$insert_field[0]='id_enfermedad'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='enfermedad'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
...
$ff=5;
$f=6;
$combo_sql[$f] = "select id_enfermedad as id_emp, nombre_emp as emp from n_enfermedad order by fecha_crea";
...
$n_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Paralelo del estudiante');
...
$m_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Paralelo del estudiante');
