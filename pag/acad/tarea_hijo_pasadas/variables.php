...
$elemento_titulo="de tareas pasadas de mis hijos"; // para el título
$elemento="tarea_hijo_pasadas"; // elemento o nomenclador al que se accede
...
$tabla_anidada2[6]='familiar';
$tabla_anidada2[7]='familiar_estudiante';
$tabla_anidada2[8]='persona AS fam';
...
$campo_anidado2[6]='id_familiar';
$campo_anidado2[7]='id_familiar_estudiante';
$campo_anidado2[8]='id_persona';
...
AND familiar.id_persona=fam.id_persona
AND fam.id_persona=usuario.id_persona
AND usuario='".$_SESSION['user']."' AND tarea.fecha_fin<'".$hoy."'";//

//$order=" estudiante.id_estudiante, tarea.fecha_fin ASC";
...
$field[7]="concat(persona.primer_apellido,' ',persona.segundo_apellido,' ',persona.primer_nombre,' ',persona.segundo_nombre)";
...
$field_busqueda[6]="persona.primer_apellido";
$field_busqueda[7]='persona.segundo_apellido';
$field_busqueda[8]="persona.primer_nombre";
$field_busqueda[9]='persona.segundo_nombre';
...
$columna[3]='Inicia';
$columna[4]='Debi&oacute; entregarse';
$columna[5]='Opcional';
$columna[6]='Clase';
$columna[7]='Estudiante';
