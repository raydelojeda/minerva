...
$elemento_titulo="de subper&iacute;odo evaluativo vigente"; // para el título
$elemento="subperiodo_evaluativo"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto al subper&iacute;odo evaluativo vigente registrados en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
$tabla="n_subperiodo_evaluativo";// tabla de la BD
...
$where=' AND n_periodo_evaluativo.id_periodo_lectivo=n_periodo_lectivo.id_periodo_lectivo AND n_periodo_lectivo.id_conf_academica=n_conf_academica.id_conf_academica AND n_conf_academica.activa="1"';

$field[0]=$tabla.'.id_subperiodo_evaluativo'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]=$tabla.'.id_periodo_evaluativo';
$field[2]="concat(abv_periodo,' - ',periodo_evaluativo)";
$field[3]='abv_subperiodo';
$field[4]='subperiodo_evaluativo';

$alias_col=array();
$alias_col[0]='ID_subperiodo_evaluativo';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='id_p';
$alias_col[2]='per';
$alias_col[3]='abv_subperiodo';
$alias_col[4]='subperiodo_evaluativo';

$columna[0]=''; // labels o encabezados, $field[0] es la llave de la tabla por tanto no lleva label (NO TOCAR)
$columna[1]='Per&iacute;odo avaluativo';
$columna[2]='Per&iacute;odo avaluativo';
$columna[3]='Abreviatura del subper&iacute;odo evaluativo';
$columna[4]='Subper&iacute;odo evaluativo';
...
$l_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Per&iacute;odo evaluativo (quimestre)');
$l_label_ayuda[1]=array('texto'=>$columna[3],'exp'=>'Abreviatura del subper&iacute;odo evaluativo (parcial)');
$l_label_ayuda[2]=array('texto'=>$columna[4],'exp'=>'Subper&iacute;odo evaluativo (Parcial)');
...
$insert_field[0]='id_subperiodo_evaluativo'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='id_periodo_evaluativo'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
$insert_field[2]='';
$insert_field[3]='abv_subperiodo';
$insert_field[4]='subperiodo_evaluativo';
...
$combo_sql[$f] = "SELECT n_periodo_evaluativo.id_periodo_evaluativo as id_p, periodo_evaluativo as per 
FROM n_periodo_evaluativo,n_periodo_lectivo,n_conf_academica WHERE 1 AND n_periodo_evaluativo.id_periodo_lectivo=n_periodo_lectivo.id_periodo_lectivo AND n_periodo_lectivo.id_conf_academica=n_conf_academica.id_conf_academica AND n_conf_academica.activa='1'";
...
$n_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Per&iacute;odo evaluativo (quimestre)');
$n_label_ayuda[1]=array('texto'=>$columna[3],'exp'=>'Abreviatura del subper&iacute;odo evaluativo (parcial)');
$n_label_ayuda[2]=array('texto'=>$columna[4],'exp'=>'Subper&iacute;odo evaluativo (Parcial)');
...
$m_label_ayuda[0]=array('texto'=>$columna[1],'exp'=>'Per&iacute;odo evaluativo (quimestre)');
$m_label_ayuda[1]=array('texto'=>$columna[3],'exp'=>'Abreviatura del subper&iacute;odo evaluativo (parcial)');
$m_label_ayuda[2]=array('texto'=>$columna[4],'exp'=>'Subper&iacute;odo evaluativo (Parcial)');
