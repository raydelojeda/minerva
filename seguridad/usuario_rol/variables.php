...
$elemento_titulo="de usuario y rol"; // para el título
$elemento="usuario_rol"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a los usuarios y roles registrados en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="usuario_rol";// tabla de la BD
...
$where=" AND usuario.id_persona=persona.id_persona ";

$field[0]='id_usuario_rol'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]=$tabla.'.id_usuario';
$field[2]="concat(primer_apellido,' ',segundo_apellido,' ',primer_nombre,' ',segundo_nombre,' - ',identificacion)";
$field[3]=$tabla.'.id_rol';
$field[4]='rol';

$alias_col=array();
$alias_col[0]='id_usuario_rol';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='id_usuario';
$alias_col[2]='persona';
$alias_col[3]='id_r';
$alias_col[4]='rol';
...
$var_mod='';
$columna_suma[0]='';
$href_m=$x.$camino.'/mod_usuario_rol.php?mod='; // camino de la pagina para Editar
...
$l_label_ayuda[0]=array('texto'=>$columna[2],'exp'=>'Usuario con acceso al sistema');
$l_label_ayuda[1]=array('texto'=>$columna[4],'exp'=>'Rol del usuario');
...
$insert_field[0]='id_usuario_rol'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='id_usuario'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
$insert_field[2]='';
$insert_field[3]='id_rol';
$insert_field[4]='';
...
$combo_sql[$ff] = "select id_usuario as id_usuario, concat(primer_apellido,' ',segundo_apellido,' ',primer_nombre,' ',segundo_nombre,' - ',identificacion) as persona from persona, usuario WHERE persona.id_persona=usuario.id_persona ORDER BY primer_apellido,segundo_apellido";
...
$n_label_ayuda[0]=array('texto'=>$columna[2],'exp'=>'Usuario con acceso al sistema');
$n_label_ayuda[1]=array('texto'=>$columna[4],'exp'=>'Rol del usuario');
...
$m_label_ayuda[0]=array('texto'=>$columna[2],'exp'=>'Usuario con acceso al sistema');
$m_label_ayuda[1]=array('texto'=>$columna[4],'exp'=>'Rol del usuario');
