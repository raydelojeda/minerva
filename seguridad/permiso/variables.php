...
$elemento_titulo="de permiso"; // para el título
$elemento="permiso"; // elemento o nomenclador al que se accede
...
$intro_ayuda="Esta p&aacute;gina muestra una ayuda respecto a los permisoes registradas en la base de datos.";//introduccion de la ayuda

//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------
//------------------------------------------------LISTAR------------------------------------------------

$tabla="permiso";// tabla de la BD

$tabla_anidada=array();
$tabla_anidada[0]='n_rol';
$tabla_anidada[1]='n_accion';
$tabla_anidada[2]='n_elemento';

$campo_anidado=array();
$campo_anidado[0]='id_rol';
$campo_anidado[1]='id_accion';
$campo_anidado[2]='id_elemento';

$field[0]='id_permiso'; // fields de la tabla en la BD, $field[0] es la llave de la tabla
$field[1]=$tabla.'.id_rol';
$field[2]='rol';
$field[3]=$tabla.'.id_accion';
$field[4]='accion';
$field[5]=$tabla.'.id_elemento';
$field[6]='elemento';


$alias_col=array();
$alias_col[0]='id_permiso';//alias de los campos de la consulta, debe haber alias en todos los campos
$alias_col[1]='id_r';
$alias_col[2]='rol';
$alias_col[3]='id_a';
$alias_col[4]='accion';
$alias_col[5]='id_e';
$alias_col[6]='elemento';

$columna[0]=''; // labels o encabezados, $field[0] es la llave de la tabla por tanto no lleva label (NO TOCAR)
$columna[1]='Rol';
$columna[2]='Rol';
$columna[3]='Acci&oacute;n';
$columna[4]='Acci&oacute;n';
$columna[5]='Elemento';
$columna[6]='Elemento';
...
$var_mod='';
$columna_suma[0]='';
$href_m=$x.$camino.'/mod_permiso.php?mod='; // camino de la pagina para Editar
...
$l_label_ayuda[0]=array('texto'=>$columna[2],'exp'=>'Rol del usuario');
$l_label_ayuda[1]=array('texto'=>$columna[4],'exp'=>'Acci&oacute;n que puede ejecutar el usuario');
$l_label_ayuda[2]=array('texto'=>$columna[6],'exp'=>'Elemento o tabla de la BD a la que se puede acceder');

$l_botones=array(); // botonera para listar que va a tener en el encabezado (NO TOCAR)
$l_botones[0]=array('target'=>'_self','href'=>'new_'.$elemento.'3.php','onclic'=>'','src'=>$x.'img/general/nuevo.png','nombre'=>'nuevo','texto'=>'Bloqueo','accion'=>'Insertar');
...
$l_botones[4]=array('target'=>'_self','href'=>'#','onclic'=>'seleccion(\'../../plantillas/eliminar.php\')','src'=>$x.'img/general/eliminar.png','nombre'=>'eliminar','texto'=>'Eliminar','accion'=>'Eliminar');
...
$insert_field[0]='id_permiso'; // campos de la tabla en la BD de la consulta para insertar, Editar, $insert_field[0] es la llave de la tabla principal
$insert_field[1]='id_rol'; // hay un # de arreglo menos pues se inserta solo los campos de la tabla
$insert_field[2]='';
$insert_field[3]='id_accion';
$insert_field[4]='';
$insert_field[5]='id_elemento';
$insert_field[6]='';
...
$ff=4;
$fff=6;
$combo_sql[$f] = "select id_rol as id_r, rol as rol from n_rol";

$opt_name=array();
$opt_name[$f][0]='rol';//dato que va a mostrar al usuario ejem: Elemento 1, Elemento 2, etc. otro: Administrador, Vendedor, Contador, Invitado, etc. 
...
$combo_sql[$ff] = "select id_accion as id_a, accion as accion from n_accion";


$opt_name[$ff][0]='accion';//dato que va a mostrar al usuario ejem: Elemento 1, Elemento 2, etc. otro: Administrador, Vendedor, Contador, Invitado, etc. 
...
$combo_sql[$fff] = "select id_elemento as id_e, elemento as ele from n_elemento";


$opt_name[$fff][0]='ele';//dato que va a mostrar al usuario ejem: Elemento 1, Elemento 2, etc. otro: Administrador, Vendedor, Contador, Invitado, etc. 
...
$n_label_ayuda[0]=array('texto'=>$columna[2],'exp'=>'Rol del usuario');
$n_label_ayuda[1]=array('texto'=>$columna[4],'exp'=>'Acci&oacute;n que puede ejecutar el usuario');
$n_label_ayuda[2]=array('texto'=>$columna[6],'exp'=>'Elemento o tabla de la BD a la que se puede acceder');
...
$m_label_ayuda[0]=array('texto'=>$columna[2],'exp'=>'Rol del usuario');
$m_label_ayuda[1]=array('texto'=>$columna[4],'exp'=>'Acci&oacute;n que puede ejecutar el usuario');
$m_label_ayuda[2]=array('texto'=>$columna[6],'exp'=>'Elemento o tabla de la BD a la que se puede acceder');
