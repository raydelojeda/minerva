...
$elemento_titulo="de usuario"; // para el título
...
$titulo_listar="Registro ".$elemento_titulo.": listar"; //titulo del encabezado
$titulo_nuevo="Registro ".$elemento_titulo.": insertar"; //titulo del encabezado
$titulo_editar="Registro ".$elemento_titulo.": Editar"; //titulo del encabezado
$titulo_ayuda="Registro ".$elemento_titulo.": ayuda"; //titulo del encabezado
...
$info_emerg[1]=''; // puede ser 1 o 2, al tener un valor diferente de vacío se muestra, si es 1 saca el valor de lo que muestra de la BD según la consulta, si es 2 saca el valor de los option estáticos
$info_emerg[2]=1;
$info_emerg[3]=1;
$info_emerg[4]='';
$info_emerg[5]=2;
...
$info_col[1]=''; // puede ser 1 o 2, al tener un valor diferente de vacío se muestra, si es 1 saca el valor de lo que muestra de la BD según la consulta, si es 2 saca el valor de los option estáticos
$info_col[2]=1;
$info_col[3]=1;
$info_col[4]='';
$info_col[5]=2;
...
$insert_field[5]='clave2';
$insert_field[6]='activo';
...
$placeholder[1]='';
$placeholder[2]='';
$placeholder[3]='Ingrese un nombre de usuario nuevo';
$placeholder[4]='Ingrese una clave nueva';
$placeholder[5]='Ingrese nuevamente la clave';
$placeholder[6]='';
...
$opt_sel[$ff][0]='id_persona';//selected del option, campo de la tabla externa de la consulta del combo, en caso que sea de forma estática se pone en uno solo "selected"
...
$n_botones[1]=array('target'=>'_self','href'=>'../autenticacion.php','onclic'=>'','src'=>$x.'img/general/cancelar.png','nombre'=>'cancelar','texto'=>'Salir','accion'=>'');
